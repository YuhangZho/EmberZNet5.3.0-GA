...
int8u recieve_cmd_type = EMBER_INCOMING_UNICAST;
#endif
                              ...
                              InterPanHeader *interPanHeader)
{
  ...
  emberAfAppPrintln("cmd.mfgSpecific: 0x%x",cmd.mfgSpecific);
  emberAfAppPrintln("cmd.clusterSpecific: 0x%x",cmd.clusterSpecific);
  if (cmd.mfgSpecific) {
    cmd.mfgCode = emberAfGetInt16u(message, cmd.payloadStartIndex, msgLen);
	emberAfAppPrintln("cmd.mfgCode: 0x%2x",cmd.mfgCode);
                                                 ...
                                                 EmberAfClusterId clusterId)
{
  ...
  if (emberAfIsCurrentSecurityProfileSmartEnergy()) {
    ...
    case ZCL_TOU_CALENDAR_CLUSTER_ID:
                                                ...
                                                int32u timeMs)
{
  ...
  return emberAfEventControlSetDelay(&controls[index], timeMs);
}
                                                  ...
                                                  int16u delay)
{
  ...
  emberEventControlSetDelayMS(controls[index], delay);
  return EMBER_SUCCESS;
}
                                                  ...
                                                  int16u delay)
{
  ...
  emberEventControlSetDelayQS(controls[index], delay);
  return EMBER_SUCCESS;
}
                                                       ...
                                                       int16u delay)
{
  ...
  emberEventControlSetDelayMinutes(controls[index], delay);
  return EMBER_SUCCESS;
}
