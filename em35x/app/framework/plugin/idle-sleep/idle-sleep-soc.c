...
static int32u fullSleep(int32u sleepDurationMS, int8u eventIndex)
{
  ...
  emberAfDebugPrintln("wakeup %l ms,sleepDurationAttemptedMS:%4x,sleepDurationMS:%4x",
                      (sleepDurationAttemptedMS - sleepDurationMS),sleepDurationAttemptedMS,sleepDurationMS);
...
{
#ifdef ROBIN_DEBUG
//	emberAfGuaranteedPrintln("Enter:emberAfCheckForSleepCallback"); // Robin add for debug
#endif
