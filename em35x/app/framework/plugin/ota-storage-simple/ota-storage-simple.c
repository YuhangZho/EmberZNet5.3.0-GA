...
// be used by clients in the process of downloading a file.z
static boolean storageHasFullImage = FALSE; //wms
...
#ifdef OTA_SENGLED_WMS
  if (FALSE == GetOtaFileState())
  {
    initDone = FALSE;
    storageHasFullImage = FALSE;
    cachedImageId.manufacturerId  = 0xFFFF;
    cachedImageId.imageTypeId     = 0xFFFF;
    cachedImageId.firmwareVersion = 0xFFFFFFFFL;
