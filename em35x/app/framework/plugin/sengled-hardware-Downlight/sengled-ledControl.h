...
#define TICS_PER_PERIOD_BASIC     30000  // based on a 6 MHz clock, the number of counts  in a 200 Hz signal.
#define TICS_PER_PERIOD           30000  // to avoid tracklight hardware issue, it can't be 99.5%

#define POWERUP_LEVEL_STABLE  35         //  to avoid downlight hardware issue
