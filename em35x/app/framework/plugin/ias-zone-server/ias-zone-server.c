...
static EmberStatus sendToClient(void)
{
  ...
  emberAfGuaranteedPrintln("sendToClient"); // Robin add for debug
...
{
	emberAfGuaranteedPrintln("emberAfIasZoneClusterServerAttributeChangedCallback"); // Robin add for debug
...
static boolean amIEnrolled(void)
{
  ...
  emberAfGuaranteedPrintln("amIEnrolled"); // Robin add for debug
...
static void updateEnrollState(boolean enrolled)
{
  ...
  emberAfGuaranteedPrintln("updateEnrollState"); // Robin add for debug
...
boolean emberAfIasZoneClusterZoneEnrollResponseCallback(int8u enrollResponseCode,
                                                        int8u zoneId)
{
	emberAfGuaranteedPrintln("emberAfIasZoneClusterZoneEnrollResponseCallback"); // Robin add for debug
...
static EmberStatus sendZoneUpdate(int8u timeSinceStatusOccurredQs)
{
  ...
  emberAfGuaranteedPrintln("sendZoneUpdate"); // Robin add for debug
...
{
	emberAfGuaranteedPrintln("emberAfPluginIasZoneServerUpdateZoneStatus"); // Robin add for debug
  emberAfWriteAttribute(myEndpoint,
                        ZCL_IAS_ZONE_CLUSTER_ID,
                        ZCL_ZONE_STATUS_ATTRIBUTE_ID, 
                        CLUSTER_MASK_SERVER,
...
{
  myEndpoint = endpoint;
  emberAfGuaranteedPrintln("emberAfIasZoneClusterServerInitCallback"); // Robin add for debug
...
{
	emberAfGuaranteedPrintln("emberAfIasZoneClusterServerTickCallback"); // Robin add for debug
...
int8u emberAfPluginIasZoneServerGetZoneId(void)
{
  ...
  emberAfGuaranteedPrintln("emberAfPluginIasZoneServerGetZoneId"); // Robin add for debug
  emberAfReadServerAttribute(myEndpoint,
                             ZCL_IAS_ZONE_CLUSTER_ID,
...
static void setZoneId(int8u zoneId)
{
	emberAfGuaranteedPrintln("setZoneId"); // Robin add for debug
