...
#ifndef __APP_SLEEP_SENSOR_H__
#define __APP_SLEEP_SENSOR_H__


/**** Included Header Section ****/

/**** ZCL Section ****/
#define ZA_PROMPT "sleep_sensor"
...
// Use this macro to check if Sengled HA Common Highbay plugin is included
#define EMBER_AF_PLUGIN_SENGLED_HA_COMMON_HIGHBAY

// Use this macro to check if Sengled Hardware Ezmode plugin is included
#define EMBER_AF_PLUGIN_SENGLED_HA_EZMODE

// Use this macro to check if Sengled HA Network Highbay plugin is included
#define EMBER_AF_PLUGIN_SENGLED_HA_NETWORK_HIGHBAY

// Use this macro to check if Sengled Hardware Highbay plugin is included
#define EMBER_AF_PLUGIN_SENGLED_HARDWARE_HIGHBAY
