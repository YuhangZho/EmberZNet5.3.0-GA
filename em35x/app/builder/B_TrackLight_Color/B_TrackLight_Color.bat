...
echo " "
@echo on
cmd /c ""%PROJECT_DIR%\..\..\..\tool\image-builder\image-builder-windows.exe" --create %TARGET_BPATH%.ota  --version 255 --manuf-id 0x1160 --image-type 0x0002 --tag-id 0x0000 --tag-file %TARGET_BPATH%.ebl --string "EBL B_TrackLight_Color" > %TARGET_BPATH%-image-builder-output.txt"
@echo off
