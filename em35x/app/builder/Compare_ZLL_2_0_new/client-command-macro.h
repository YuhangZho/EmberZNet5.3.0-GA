...
/** @name RGB Test Commands */
// @{
/** @brief Command description for RGBPWMControl
 *
 * Cluster: RGB Test, This cluster provides SengLed RGB test
 * Command: RGB_PWMControl
 * @param RGB int8u
 * @param PWMData int8u
 */
#define emberAfFillCommandSengledRgbTestClusterRGB_PWMControl(RGB, \
                                                              PWMData) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER\
                                                 | ZCL_DISABLE_DEFAULT_RESPONSE_MASK), \
                                                ZCL_SENGLED_RGB_TEST_CLUSTER_ID, \
                                                0x1160, \
                                                ZCL_R_G_B__P_W_M_CONTROL_COMMAND_ID, \
                                                "uu", \
                                                RGB, \
                                                PWMData);


/** @} END RGB Test Commands */
