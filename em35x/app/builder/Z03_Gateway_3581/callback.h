...
/** @name Z03 Gateway App Plugin Callbacks */
// @{
 ...
 */
boolean emberAfPluginZ03GatewayAppMakeJoinDecisionCallback(EmberNodeId nodeId,
                                                           EmberEUI64 nodeEUI64);

/** @} END Z03 Gateway App Plugin Callbacks */
