...
/** @name Sengled Cluster Callbacks */
// @{

/** @brief Sengled Cluster Client Attribute Changed
 *
 * Client Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute that changed  Ver.: always
 */
void emberAfSengledClusterClientAttributeChangedCallback(int8u endpoint,
                                                         EmberAfAttributeId attributeId);
/** @brief Sengled Cluster Client Default Response
 *
 * This function is called when the client receives the default response from
 * the server.
 *
 ...
 * @param status Status in default response  Ver.: always
 */
void emberAfSengledClusterClientDefaultResponseCallback(int8u endpoint,
                                                        int8u commandId,
                                                        EmberAfStatus status);
/** @brief Sengled Cluster Client Init
 *
 * Client Init
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 */
void emberAfSengledClusterClientInitCallback(int8u endpoint);
/** @brief Sengled Cluster Client Manufacturer Specific Attribute Changed
 *
 * Client Manufacturer Specific Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * Ver.: always
 */
void emberAfSengledClusterClientManufacturerSpecificAttributeChangedCallback(int8u endpoint,
                                                                             EmberAfAttributeId attributeId,
                                                                             int16u manufacturerCode);
/** @brief Sengled Cluster Client Message Sent
 *
 * Client Message Sent
 *
 * @param type The type of message sent  Ver.: always
 ...
 * @param status The status of the sent message  Ver.: always
 */
void emberAfSengledClusterClientMessageSentCallback(EmberOutgoingMessageType type,
                                                    int16u indexOrDestination,
                                                    EmberApsFrame *apsFrame,
                                                    int16u msgLen,
                                                    int8u *message,
                                                    EmberStatus status);
/** @brief Sengled Cluster Client Pre Attribute Changed
 *
 * Client Pre Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * @param value Attribute value  Ver.: always
 */
EmberAfStatus emberAfSengledClusterClientPreAttributeChangedCallback(int8u endpoint,
                                                                     EmberAfAttributeId attributeId,
                                                                     EmberAfAttributeType attributeType,
                                                                     int8u size,
                                                                     int8u *value);
/** @brief Sengled Cluster Client Tick
 *
 * Client Tick
 *
 * @param endpoint Endpoint that is being served  Ver.: always
 */
void emberAfSengledClusterClientTickCallback(int8u endpoint);
/** @brief Sengled Cluster Move Temp To Level
 *
 * 
 *
 * @param level   Ver.: always
 * @param transitionTime   Ver.: always
 */
boolean emberAfSengledClusterMoveTempToLevelCallback(int8u level,
                                                     int16u transitionTime);
/** @brief Sengled Cluster Server Attribute Changed
 *
 * Server Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute that changed  Ver.: always
 */
void emberAfSengledClusterServerAttributeChangedCallback(int8u endpoint,
                                                         EmberAfAttributeId attributeId);
/** @brief Sengled Cluster Server Default Response
 *
 * This function is called when the server receives the default response from
 * the client.
 *
 ...
 * @param status Status in default response  Ver.: always
 */
void emberAfSengledClusterServerDefaultResponseCallback(int8u endpoint,
                                                        int8u commandId,
                                                        EmberAfStatus status);
/** @brief Sengled Cluster Server Init
 *
 * Server Init
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 */
void emberAfSengledClusterServerInitCallback(int8u endpoint);
/** @brief Sengled Cluster Server Manufacturer Specific Attribute Changed
 *
 * Server Manufacturer Specific Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
...
void emberAfSengledClusterServerManufacturerSpecificAttributeChangedCallback(int8u endpoint,
                                                                             EmberAfAttributeId attributeId,
                                                                             int16u manufacturerCode);
/** @brief Sengled Cluster Server Message Sent
 *
 * Server Message Sent
 *
 * @param type The type of message sent  Ver.: always
 ...
 * @param status The status of the sent message  Ver.: always
 */
void emberAfSengledClusterServerMessageSentCallback(EmberOutgoingMessageType type,
                                                    int16u indexOrDestination,
                                                    EmberApsFrame *apsFrame,
                                                    int16u msgLen,
                                                    int8u *message,
                                                    EmberStatus status);
/** @brief Sengled Cluster Server Pre Attribute Changed
 *
 * Server Pre Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * @param value Attribute value  Ver.: always
 */
EmberAfStatus emberAfSengledClusterServerPreAttributeChangedCallback(int8u endpoint,
                                                                     EmberAfAttributeId attributeId,
                                                                     EmberAfAttributeType attributeType,
                                                                     int8u size,
                                                                     int8u *value);
/** @brief Sengled Cluster Server Tick
 *
 * Server Tick
 *
 * @param endpoint Endpoint that is being served  Ver.: always
 */
void emberAfSengledClusterServerTickCallback(int8u endpoint);

/** @} END Sengled Cluster Callbacks */
