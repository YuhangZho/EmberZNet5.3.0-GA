...
/** @name Sengled Commands */
// @{
/** @brief Command description for MoveTempToLevel
 *
 * Cluster: Sengled, This cluster provides SengLed APP.
 * Command: MoveTempToLevel
 * @param level int8u
 * @param transitionTime int16u
 */
#define emberAfFillCommandSengledClusterMoveTempToLevel(level, \
                                                        transitionTime) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER\
                                                ...
                                                0x1901, \
                                                ZCL_MOVE_TEMP_TO_LEVEL_COMMAND_ID, \
                                                "uv", \
                                                level, \
                                                transitionTime);


/** @} END Sengled Commands */
