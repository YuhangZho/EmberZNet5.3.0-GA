...
// Printing macros for cluster: TOU Calendar
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_TOU_CALENDAR_CLUSTER)
#define emberAfTouCalendarClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_TOU_CALENDAR_CLUSTER, __VA_ARGS__)
#define emberAfTouCalendarClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_TOU_CALENDAR_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfTouCalendarClusterFlush()
#define emberAfTouCalendarClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_TOU_CALENDAR_CLUSTER) ) { x; }
#define emberAfTouCalendarClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_TOU_CALENDAR_CLUSTER, (buffer), (len), (withSpace))
#define emberAfTouCalendarClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_TOU_CALENDAR_CLUSTER, (buffer))
#else
#define emberAfTouCalendarClusterPrint(...)
#define emberAfTouCalendarClusterPrintln(...)
#define emberAfTouCalendarClusterFlush()
#define emberAfTouCalendarClusterDebugExec(x)
#define emberAfTouCalendarClusterPrintBuffer(buffer, len, withSpace)
#define emberAfTouCalendarClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_TOU_CALENDAR_CLUSTER)
...
// Printing macros for cluster: par38 control
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_PAR38_CONTROL_CLUSTER)
#define emberAfPar38ControlClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_PAR38_CONTROL_CLUSTER, __VA_ARGS__)
#define emberAfPar38ControlClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_PAR38_CONTROL_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfPar38ControlClusterFlush()
#define emberAfPar38ControlClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_PAR38_CONTROL_CLUSTER) ) { x; }
#define emberAfPar38ControlClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_PAR38_CONTROL_CLUSTER, (buffer), (len), (withSpace))
#define emberAfPar38ControlClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_PAR38_CONTROL_CLUSTER, (buffer))
#else
#define emberAfPar38ControlClusterPrint(...)
#define emberAfPar38ControlClusterPrintln(...)
#define emberAfPar38ControlClusterFlush()
#define emberAfPar38ControlClusterDebugExec(x)
#define emberAfPar38ControlClusterPrintBuffer(buffer, len, withSpace)
#define emberAfPar38ControlClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_PAR38_CONTROL_CLUSTER)


// Printing macros for cluster: mobile control
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_MOBILE_CONTROL_CLUSTER)
#define emberAfMobileControlClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_MOBILE_CONTROL_CLUSTER, __VA_ARGS__)
#define emberAfMobileControlClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_MOBILE_CONTROL_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfMobileControlClusterFlush()
#define emberAfMobileControlClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_MOBILE_CONTROL_CLUSTER) ) { x; }
#define emberAfMobileControlClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_MOBILE_CONTROL_CLUSTER, (buffer), (len), (withSpace))
#define emberAfMobileControlClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_MOBILE_CONTROL_CLUSTER, (buffer))
#else
#define emberAfMobileControlClusterPrint(...)
#define emberAfMobileControlClusterPrintln(...)
#define emberAfMobileControlClusterFlush()
#define emberAfMobileControlClusterDebugExec(x)
#define emberAfMobileControlClusterPrintBuffer(buffer, len, withSpace)
#define emberAfMobileControlClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_MOBILE_CONTROL_CLUSTER)


// Printing macros for cluster: rgb calibration
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_RGB_CALIRATION_CLUSTER)
#define emberAfRgbCalirationClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_RGB_CALIRATION_CLUSTER, __VA_ARGS__)
#define emberAfRgbCalirationClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_RGB_CALIRATION_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfRgbCalirationClusterFlush()
#define emberAfRgbCalirationClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_RGB_CALIRATION_CLUSTER) ) { x; }
#define emberAfRgbCalirationClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_RGB_CALIRATION_CLUSTER, (buffer), (len), (withSpace))
#define emberAfRgbCalirationClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_RGB_CALIRATION_CLUSTER, (buffer))
#else
#define emberAfRgbCalirationClusterPrint(...)
#define emberAfRgbCalirationClusterPrintln(...)
#define emberAfRgbCalirationClusterFlush()
#define emberAfRgbCalirationClusterDebugExec(x)
#define emberAfRgbCalirationClusterPrintBuffer(buffer, len, withSpace)
#define emberAfRgbCalirationClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_RGB_CALIRATION_CLUSTER)


// Printing macros for cluster: light auto reset mark
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_AUTO_RESET_CLUSTER)
#define emberAfAutoResetClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_AUTO_RESET_CLUSTER, __VA_ARGS__)
#define emberAfAutoResetClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_AUTO_RESET_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfAutoResetClusterFlush()
#define emberAfAutoResetClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_AUTO_RESET_CLUSTER) ) { x; }
#define emberAfAutoResetClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_AUTO_RESET_CLUSTER, (buffer), (len), (withSpace))
#define emberAfAutoResetClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_AUTO_RESET_CLUSTER, (buffer))
#else
#define emberAfAutoResetClusterPrint(...)
#define emberAfAutoResetClusterPrintln(...)
#define emberAfAutoResetClusterFlush()
#define emberAfAutoResetClusterDebugExec(x)
#define emberAfAutoResetClusterPrintBuffer(buffer, len, withSpace)
#define emberAfAutoResetClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_AUTO_RESET_CLUSTER)


// Printing macros for cluster: diagnose code itself
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_DIAG_CODE_CLUSTER)
#define emberAfDiagCodeClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_DIAG_CODE_CLUSTER, __VA_ARGS__)
#define emberAfDiagCodeClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_DIAG_CODE_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfDiagCodeClusterFlush()
#define emberAfDiagCodeClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_DIAG_CODE_CLUSTER) ) { x; }
#define emberAfDiagCodeClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_DIAG_CODE_CLUSTER, (buffer), (len), (withSpace))
#define emberAfDiagCodeClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_DIAG_CODE_CLUSTER, (buffer))
#else
#define emberAfDiagCodeClusterPrint(...)
#define emberAfDiagCodeClusterPrintln(...)
#define emberAfDiagCodeClusterFlush()
#define emberAfDiagCodeClusterDebugExec(x)
#define emberAfDiagCodeClusterPrintBuffer(buffer, len, withSpace)
#define emberAfDiagCodeClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_DIAG_CODE_CLUSTER)
