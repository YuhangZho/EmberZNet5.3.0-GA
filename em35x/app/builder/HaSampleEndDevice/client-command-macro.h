 ...
 *
 * Cluster: Over the Air Bootloading, ZigBee Over-the-air Bootloading cluster
 * Command: ImageNotify
...
/** @brief This command initiates a PublishConversionFactor command for the scheduled conversion factor updates.
 *
 * Cluster: Price, The Price Cluster provides the mechanism for communicating Gas, Energy, or Water pricing information within the premise.
...
/** @brief This command initiates a PublishCalorificValue command for the scheduled conversion factor updates.
 *
 * Cluster: Price, The Price Cluster provides the mechanism for communicating Gas, Energy, or Water pricing information within the premise.
 ...
 */
#define emberAfFillCommandPriceClusterPublishCO2Value(issuerEventId, \
                                                      startTime, \
                                                      tariffType, \
                                                      cO2Value, \
                                                      cO2ValueUnit, \
 ...
 */
#define emberAfFillCommandPriceClusterPublishConsolidatedBill(issuerEventId, \
                                                              billingPeriodStartTime, \
                                                              billingPeriodDuration, \
                                                              tariffType, \
                                                              consolidatedBill, \
...
/** @brief This command initiates a PublishTariffInformation command for the scheduled tariff updates.
 *
 * Cluster: Price, The Price Cluster provides the mechanism for communicating Gas, Energy, or Water pricing information within the premise.
...
/** @brief This command initiates a PublishPriceMatrix command for the scheduled Price Matrix updates.
 *
 * Cluster: Price, The Price Cluster provides the mechanism for communicating Gas, Energy, or Water pricing information within the premise.
...
/** @brief This command initiates a PublishBlockThreshold command for the scheduled Block Threshold updates.
 *
 * Cluster: Price, The Price Cluster provides the mechanism for communicating Gas, Energy, or Water pricing information within the premise.
...
/** @brief This command initiates a PublishCO2Value command for the scheduled CO2 conversion factor updates.
 *
 * Cluster: Price, The Price Cluster provides the mechanism for communicating Gas, Energy, or Water pricing information within the premise.
 * Command: GetCO2Value
 * @param earliestStartTime int32u
...
/** @brief This command allows a client to retrieve the tier labels associated with a given tariff; this command initiates a PublishTierLabels command from the server.
 *
 * Cluster: Price, The Price Cluster provides the mechanism for communicating Gas, Energy, or Water pricing information within the premise.
...
/** @brief This command initiates one or more PublishBillingPeriod commands for the currently scheduled billing periods.
 *
 * Cluster: Price, The Price Cluster provides the mechanism for communicating Gas, Energy, or Water pricing information within the premise.
 ...
 * @param tariffType int8u
 */
#define emberAfFillCommandPriceClusterGetBillingPeriod(startTime, \
                                                       minIssuerEventId, \
                                                       numberOfCommands, \
                                                       tariffType) \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
...
/** @brief This command initiates one or more PublishConsolidatedBill commands with the requested billing information.
 *
 * Cluster: Price, The Price Cluster provides the mechanism for communicating Gas, Energy, or Water pricing information within the premise.
 ...
 * @param tariffType int8u
 */
#define emberAfFillCommandPriceClusterGetConsolidatedBill(startTime, \
                                                          minIssuerEventId, \
                                                          numberOfCommands, \
                                                          tariffType) \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
...
/** @brief The CPPEventResponse command is sent from a Client (IPD) to the ESI to notify them of a Critical Peak Pricing event authorisation.
 *
 * Cluster: Price, The Price Cluster provides the mechanism for communicating Gas, Energy, or Water pricing information within the premise.
...
/** @brief This command initiates PublishCreditPayment commands for the requested credit payment information.
 *
 * Cluster: Price, The Price Cluster provides the mechanism for communicating Gas, Energy, or Water pricing information within the premise.
...
/** @brief This command initiates a PublishCurrencyConversion command for the currency conversion factor updates. A server shall be capable of storing both the old and the new currencies.
 *
 * Cluster: Price, The Price Cluster provides the mechanism for communicating Gas, Energy, or Water pricing information within the premise.
...
/** @brief This command initiates the return of the last CancelTariff command held on the associated server.
 *
 * Cluster: Price, The Price Cluster provides the mechanism for communicating Gas, Energy, or Water pricing information within the premise.
...
/** @brief Command to configure a mirror to understand notification schemes and all associated behavior.
 *
 * Cluster: Simple Metering, The Metering Cluster provides a mechanism to retrieve usage information from Electric, Gas, Water, and potentially Thermal metering devices.
 * Command: ConfigureMirror
 * @param issuerEventId int32u
 * @param changeReportingProfile int32u
...
/** @brief This command is sent to the mirror once the mirror has been created. The command deals with the operational configuration of the Mirror and the device that reports to the mirror. No default schemes are allowed to be overwritten.
 *
 * Cluster: Simple Metering, The Metering Cluster provides a mechanism to retrieve usage information from Electric, Gas, Water, and potentially Thermal metering devices.
...
/** @brief The GetNotificationFlag command is used only when a BOMD is being mirrored. This command provides a method for the BOMD to notify the Mirror message queue that it wants to receive commands that the Mirror has queued. The Notification flags set within the command shall inform the mirror of the commands that the BOMD is requesting.
 *
 * Cluster: Simple Metering, The Metering Cluster provides a mechanism to retrieve usage information from Electric, Gas, Water, and potentially Thermal metering devices.
 * Command: GetNotificationFlag
 * @param notificationScheme int8u
 * @param notificationFlagAttributeId int16u
 * @param notificationFlagsN int32u
 */
#define emberAfFillCommandSimpleMeteringClusterGetNotificationFlag(notificationScheme, \
                                                                   notificationFlagAttributeId, \
                                                                   notificationFlagsN) \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                             | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT), \
                            ZCL_SIMPLE_METERING_CLUSTER_ID, \
                            ZCL_GET_NOTIFICATION_FLAG_COMMAND_ID, \
                            "uvw", \
                            notificationScheme, \
                            notificationFlagAttributeId, \
                            notificationFlagsN);
...
/** @brief This command is used to tell the cluster server to take a snapshot.
 *
 * Cluster: Simple Metering, The Metering Cluster provides a mechanism to retrieve usage information from Electric, Gas, Water, and potentially Thermal metering devices.
...
/** @brief This command is used to respond to manual requests to take a snapshot.
 *
 * Cluster: Simple Metering, The Metering Cluster provides a mechanism to retrieve usage information from Electric, Gas, Water, and potentially Thermal metering devices.
...
/** @brief This command is used to send snapshot data to the client.
 *
 * Cluster: Simple Metering, The Metering Cluster provides a mechanism to retrieve usage information from Electric, Gas, Water, and potentially Thermal metering devices.
 ...
 */
#define emberAfFillCommandSimpleMeteringClusterGetSampledDataResponse(sampleRequestId, \
                                                                      sampleStartTime, \
                                                                      sampleType, \
                                                                      numberOfSamples, \
                                                                      samples, \
 ...
 * @param numberOfSamples int16u
 */
#define emberAfFillCommandSimpleMeteringClusterGetSampledData(sampleRequestId, \
                                                              sampleStartTime, \
                                                              sampleType, \
                                                              numberOfSamples) \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
...
/** @brief This command is sent in response to the ReportAttribute command when the corresponding Enable Bit of the MirrorControl attribute is set.
 *
 * Cluster: Simple Metering, The Metering Cluster provides a mechanism to retrieve usage information from Electric, Gas, Water, and potentially Thermal metering devices.
 ...
 * @param debtRecoveryAmount int32s
 * @param debtRecoveryBalancePercentage int16u
 */
#define emberAfFillCommandPrepaymentClusterChangeDebt(commandIssueDateTime, \
                                                      debtLabel, \
                                                      debtAmount, \
                                                      debtRecoveryMethod, \
                                                      debtType, \
 ...
 * @param creditAdjustmentValue int32s
 */
 ...
 * @param supplierId int32u
 * @param issuerEventId int32u
 * @param implementationDateTime int32u
 * @param proposedPaymentControl int16u
 * @param cutOffValue int32s
 */
#define emberAfFillCommandPrepaymentClusterChangePaymentMode(supplierId, \
                                                             issuerEventId, \
                                                             implementationDateTime, \
                                                             proposedPaymentControl, \
                                                             cutOffValue) \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                            ZCL_PREPAYMENT_CLUSTER_ID, \
 ...
 * @param startTime int32u
 * @param numberOfSnapshots int8u
 * @param snapshotCause int16u
 */
#define emberAfFillCommandPrepaymentClusterGetPrepaySnapshot(startTime, \
                                                             numberOfSnapshots, \
                                                             snapshotCause) \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
 ...
 * @param numberOfEvents int8u
 */
#define emberAfFillCommandPrepaymentClusterGetTopUpLog(numberOfEvents) \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                            ZCL_PREPAYMENT_CLUSTER_ID, \
...
/** @brief This command is sent to the Metering Device to set the warning level for low credit. It can be sent from either the HES or the IHU.
 *
 * Cluster: Prepayment, The Prepayment Cluster provides the facility to pass messages relating to prepayment between devices on the HAN.
 ...
 *
 * Cluster: Prepayment, The Prepayment Cluster provides the facility to pass messages relating to prepayment between devices on the HAN.
 * Command: GetDebtRepaymentyLog
 * @param numberOfDebt int8u
 * @param debtType int8u
 */
#define emberAfFillCommandPrepaymentClusterGetDebtRepaymentyLog(numberOfDebt, \
                                                                debtType) \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                            ZCL_PREPAYMENT_CLUSTER_ID, \
                            ZCL_GET_DEBT_REPAYMENTY_LOG_COMMAND_ID, \
                            "uu", \
                            numberOfDebt, \
                            debtType);
 ...
 *
 * Cluster: Prepayment, The Prepayment Cluster provides the facility to pass messages relating to prepayment between devices on the HAN.
 * Command: GetPrepaySnapshotResponse
 * @param issuerEventId int32u
 * @param snapshotTime int32u
 * @param commandIndex int8u
 * @param snapshotCause int16u
 ...
 * @param snapshotPayloadLen int16u
 */
#define emberAfFillCommandPrepaymentClusterGetPrepaySnapshotResponse(issuerEventId, \
                                                                     snapshotTime, \
                                                                     commandIndex, \
                                                                     snapshotCause, \
                                                                     snapshotPayloadType, \
  ...
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                             | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT), \
                            ZCL_PREPAYMENT_CLUSTER_ID, \
                            ZCL_GET_PREPAY_SNAPSHOT_RESPONSE_COMMAND_ID, \
                            "wwuvub", \
                            issuerEventId, \
                            snapshotTime, \
                            commandIndex, \
...
/** @brief Metering device responses either with amount available in the Top Up and Credit remaining after addition of this Top Up when Top up code is supplied or with supply status (after implementation) when connect/disconnect top up code is supplied.
 *
 * Cluster: Prepayment, The Prepayment Cluster provides the facility to pass messages relating to prepayment between devices on the HAN.
 * Command: ConsumerTopUpResponse
 * @param resultType int8u
 * @param topUpValue int32s
 * @param sourceOfTopUp int8u
 * @param creditRemaining int32s
 */
...
/** @brief The Get Command is used only when a BOMD Meter is being mirrored.
 *
 * Cluster: Prepayment, The Prepayment Cluster provides the facility to pass messages relating to prepayment between devices on the HAN.
 * Command: GetCommand
 * @param prePayNotificationFlags int32u
 */
#define emberAfFillCommandPrepaymentClusterGetCommand(prePayNotificationFlags) \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                             | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT), \
                            ZCL_PREPAYMENT_CLUSTER_ID, \
                            ZCL_GET_COMMAND_COMMAND_ID, \
                            "w", \
 ...
 * @param topUpCodes int8u*
 * @param topUpCodesLen int16u
 */
 ...
 *
 * Cluster: Energy Management, Energy Management cluster
 * Command: ReportEventStatus
 * @param issuerEventId int32u
 * @param eventStatus int8u
 * @param eventStatusTime int32u
 ...
 *
 * Cluster: TOU Calendar, TOU Calendar cluster
 ...
 */
#define emberAfFillCommandTouCalendarClusterPublishCalendar(providerId, \
                                                            issuerEventId, \
                                                            issuerCalendarId, \
                                                            startTime, \
                                                            calendarType, \
 ...
 */
#define emberAfFillCommandTouCalendarClusterPublishDayProfile(providerId, \
                                                              issuerEventId, \
                                                              issuerCalendarId, \
                                                              dayId, \
 ...
 */
#define emberAfFillCommandTouCalendarClusterPublishWeekProfile(providerId, \
                                                               issuerEventId, \
                                                               issuerCalendarId, \
                                                               weekId, \
                                                               dayIdRefMonday, \
 ...
 */
#define emberAfFillCommandTouCalendarClusterPublishSeasons(providerId, \
                                                           issuerEventId, \
                                                           issuerCalendarId, \
                                                           commandIndex, \
                                                           totalNumberOfCommands, \
 ...
 */
#define emberAfFillCommandTouCalendarClusterPublishSpecialDays(providerId, \
                                                               issuerEventId, \
                                                               issuerCalendarId, \
                                                               startTime, \
                                                               calendarType, \
 ...
 * @param calendarType int8u
 */
#define emberAfFillCommandTouCalendarClusterCancelCalendar(providerId, \
                                                           issuerEventId, \
                                                           calendarType) \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                             | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT), \
...
/** @brief This command initiates PublishCalendar command(s) for scheduled TOU Calendar updates.
 *
 * Cluster: TOU Calendar, TOU Calendar cluster
 * Command: GetCalendar
 * @param earliestStartTime int32u
 ...
 * @param providerId int32u
 */
#define emberAfFillCommandTouCalendarClusterGetCalendar(earliestStartTime, \
                                                        minIssuerEventId, \
                                                        numberOfCalendars, \
                                                        calendarType, \
                                                        providerId) \
...
/** @brief This command initiates one or more PublishDayProfile commands for the referenced TOU Calendar.
 *
 * Cluster: TOU Calendar, TOU Calendar cluster
 ...
 */
#define emberAfFillCommandTouCalendarClusterGetDayProfiles(providerId, \
                                                           issuerCalendarId, \
                                                           startDayId, \
                                                           numberOfDays) \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
...
/** @brief This command initiates one or more PublishWeekProfile commands for the referenced TOU Calendar.
 *
 * Cluster: TOU Calendar, TOU Calendar cluster
 ...
 */
#define emberAfFillCommandTouCalendarClusterGetWeekProfiles(providerId, \
                                                            issuerCalendarId, \
                                                            startWeekId, \
                                                            numberOfWeeks) \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
...
/** @brief This command initiates one or more PublishSeasons commands for the referenced TOU Calendar.
 *
 * Cluster: TOU Calendar, TOU Calendar cluster
 * Command: GetSeasons
 * @param providerId int32u
 * @param issuerCalendarId int32u
 */
#define emberAfFillCommandTouCalendarClusterGetSeasons(providerId, \
                                                       issuerCalendarId) \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                            ZCL_TOU_CALENDAR_CLUSTER_ID, \
 ...
 * @param issuerCalendarId int32u
 */
#define emberAfFillCommandTouCalendarClusterGetSpecialDays(startTime, \
                                                           numberOfEvents, \
                                                           calendarType, \
                                                           providerId, \
                                                           issuerCalendarId) \
 ...
 */
#define emberAfFillCommandTouCalendarClusterGetCalendarCancellation() \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                            ZCL_TOU_CALENDAR_CLUSTER_ID, \
...
/** @} END TOU Calendar Commands */


/** @name Device Management Commands */
// @{
/** @brief This command is used to request the ESI to update any device that is bound to it when the next change of Tenancy is.
 *
 * Cluster: Device Management, Device Management cluster
...
/** @brief This command is used to request the ESI to update any device that is bound to it when the next change of Supplier is.
 *
 * Cluster: Device Management, Device Management cluster
...
/** @brief This command is used to request the ESI to update any device that is bound to it what the last change in supply was or is pending.
 *
 * Cluster: Device Management, Device Management cluster
 * Command: GetChangeSupply
 */
#define emberAfFillCommandDeviceManagementClusterGetChangeSupply() \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                            ZCL_DEVICE_MANAGEMENT_CLUSTER_ID, \
                            ZCL_GET_CHANGE_SUPPLY_COMMAND_ID, \
                            "");


/** @brief This command is transmitted by a Metering Device in response to a Change Supply command.
 *
 * Cluster: Device Management, Device Management cluster
 ...
 */
#define emberAfFillCommandDeviceManagementClusterSupplyStatusResponse(providerId, \
                                                                      issuerEventId, \
                                                                      implementationDateTime, \
                                                                      supplyStatus) \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
...
/** @brief This command is used to request the ESI to  the current Uncontrolled Flow Rate configuration data.
 *
 * Cluster: Device Management, Device Management cluster
 * Command: GetUncontrolledFlowThreshold
 */
#define emberAfFillCommandDeviceManagementClusterGetUncontrolledFlowThreshold() \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                            ZCL_DEVICE_MANAGEMENT_CLUSTER_ID, \
                            ZCL_GET_UNCONTROLLED_FLOW_THRESHOLD_COMMAND_ID, \
                            "");
 ...
 */
#define emberAfFillCommandDeviceManagementClusterPublishChangeOfTenancy(supplierId, \
                                                                        issuerEventId, \
                                                                        tariffType, \
                                                                        implementationDateTime, \
 ...
 * @param currentSupplierId int32u
 * @param issuerEventId int32u
 * @param tariffType int8u
 * @param proposedChangeSupplierId int32u
 * @param supplierIdImplementationTime int32u
 * @param supplierChangeControl int32u
 * @param proposedSupplierIdName int8u*
 */
#define emberAfFillCommandDeviceManagementClusterPublishChangeOfSupplier(currentSupplierId, \
                                                                         issuerEventId, \
                                                                         tariffType, \
                                                                         proposedChangeSupplierId, \
                                                                         supplierIdImplementationTime, \
                                                                         supplierChangeControl, \
                                                                         proposedSupplierIdName) \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                             | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT), \
                            ZCL_DEVICE_MANAGEMENT_CLUSTER_ID, \
...
/** @brief This command is sent to the Metering Device to instruct it to change the status of the valve or disconnector, i.e. the Supply.
 *
 * Cluster: Device Management, Device Management cluster
 * Command: ChangeSupply
 * @param supplierId int32u
 * @param issuerEventId int32u
 * @param requestedDateTime int32u
 * @param implementationDateTime int32u
 * @param proposedSupplyStatus int8u
 * @param originatorIdSupplyControlBits int8u
 */
#define emberAfFillCommandDeviceManagementClusterChangeSupply(supplierId, \
                                                              issuerEventId, \
                                                              requestedDateTime, \
                                                              implementationDateTime, \
...
/** @brief This command is used to send the current password the client.
 *
 * Cluster: Device Management, Device Management cluster
...
/** @brief This command is a simplified version of the change supply command intended to be sent from an IPD to a meter as the consequence of a user action on the IPD.
 *
 * Cluster: Device Management, Device Management cluster
 * Command: LocalChangeSupply
 * @param proposedSupplyStatus int8u
 */
#define emberAfFillCommandDeviceManagementClusterLocalChangeSupply(proposedSupplyStatus) \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                             | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT), \
                            ZCL_DEVICE_MANAGEMENT_CLUSTER_ID, \
...
/** @brief This  command  is  used  to  specify  the  required  status  of  the  supply  following  the  occurance  of certain events  on the meter.  The meter shall check these  requirements  to understand  whether  the supply should be disabled or enabled following one of these events.
 *
 * Cluster: Device Management, Device Management cluster
 ...
 */
#define emberAfFillCommandDeviceManagementClusterSetSupplyStatus(issuerEventId, \
                                                                 supplyTamperState, \
 ...
 * @param eventGroupId int8u
 * @param eventCode int8u
 */
#define emberAfFillCommandDeviceManagementClusterGetEventConfiguration(eventGroupId, \
                                                                       eventCode) \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                             | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT), \
                            ZCL_DEVICE_MANAGEMENT_CLUSTER_ID, \
 ...
 *
 * Cluster: Device Management, Device Management cluster
 * Command: PublishUncontrolledFlowThreshold
 * @param providerId int32u
 * @param issuerEventId int32u
 ...
 */
#define emberAfFillCommandDeviceManagementClusterPublishUncontrolledFlowThreshold(providerId, \
                                                                                  issuerEventId, \
  ...
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                             | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT), \
                            ZCL_DEVICE_MANAGEMENT_CLUSTER_ID, \
                            ZCL_PUBLISH_UNCONTROLLED_FLOW_THRESHOLD_COMMAND_ID, \
                            "wwvuvvuv", \
                            providerId, \
                            issuerEventId, \
                            uncontrolledFlowThreshold, \
 ...
 *
 * Cluster: Events, Events cluster
 * Command: GetEventLog
 * @param logIdEventControl int8u
 ...
 */
#define emberAfFillCommandEventsClusterGetEventLog(logIdEventControl, \
                                                   eventId, \
                                                   startTime, \
                                                   endTime, \
                                                   numberOfEvents, \
...
/** @brief The ClearEventLog command clears the contents of the specified event log.
 *
 * Cluster: Events, Events cluster
 * Command: ClearEventLog
 * @param logId int8u
 */
#define emberAfFillCommandEventsClusterClearEventLog(logId) \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                            ZCL_EVENTS_CLUSTER_ID, \
                            ZCL_CLEAR_EVENT_LOG_COMMAND_ID, \
                            "u", \
                            logId);
 ...
 *
 * Cluster: MDU Pairing, MDU Pairing Cluster
 ...
 *
 * Cluster: Data Rate Control, desc
 ...
 *
 * Cluster: Voice over ZigBee, desc
...
/** @name par38 control Commands */
// @{
/** @} END par38 control Commands */


/** @name mobile control Commands */
// @{
/** @brief Command description for MobileControl
 *
 * Cluster: mobile control, This cluster provides SengLed Mobile Control.
 * Command: mobile control
 * @param control_type int16u
 * @param control_data int16u
 * @param transition_time int16u
 */
#define emberAfFillCommandMobileControlClustermobile control(control_type, \
                                                             control_data, \
                                                             transition_time) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_MOBILE_CONTROL_CLUSTER_ID, \
                                                0x1160, \
                                                ZCL_MOBILE_CONTROL_COMMAND_ID, \
                                                "vvv", \
                                                control_type, \
                                                control_data, \
                                                transition_time);
...
/** @} END mobile control Commands */


/** @name rgb calibration Commands */
// @{
/** @brief Command description for sengled_test
 *
 * Cluster: rgb calibration, This cluster provides rgb calibration
 * Command: rgb_calibration
 * @param cali_cmd int8u
 * @param cali_data int32u
 */
#define emberAfFillCommandRgbCalirationClusterrgb_calibration(cali_cmd, \
                                                              cali_data) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
...
/** @} END rgb calibration Commands */


/** @name light auto reset mark Commands */
// @{
/** @} END light auto reset mark Commands */


/** @name diagnose code itself Commands */
// @{
/** @brief Command description for diagnose code
 *
 * Cluster: diagnose code itself, This cluster provides diagnose code interface through a broadcast cmd.
 * Command: diag code broadcast
 * @param context int8u*
 */
#define emberAfFillCommandDiagCodeClusterServerToClientdiag code broadcast(context) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT), \
 ...
 * @param context int8u*
 */
#define emberAfFillCommandDiagCodeClusterClientToServerdiag code broadcast(context) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_DIAG_CODE_CLUSTER_ID, \
...
/** @} END diagnose code itself Commands */
