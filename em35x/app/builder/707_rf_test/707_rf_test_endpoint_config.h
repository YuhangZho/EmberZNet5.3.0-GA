...
#define GENERATED_CLUSTERS { \
    ...
    { 0xFC03, (EmberAfAttributeMetadata*)&(generatedAttributes[9]), 0, 0, (CLUSTER_MASK_CLIENT), NULL,  },    \
  }


// Endpoint types
#define GENERATED_ENDPOINT_TYPES {        \
    { (EmberAfCluster*)&(generatedClusters[0]), 10, 9 }, \
  }
...
#define EMBER_AF_GENERATED_EVENT_CODE \
  ...
  extern void ReadAttrTestFunction(void); \
  extern EmberEventControl TestSendFailCntControl; \
  extern void TestSendFailCntFunction(void); \
...
#define EMBER_AF_GENERATED_EVENTS   \
  ...
  { &ReadAttrTestControl, ReadAttrTestFunction }, \
  { &TestSendFailCntControl, TestSendFailCntFunction }, \
...
#define EMBER_AF_GENERATED_EVENT_STRINGS   \
  ...
  "button Custom",  \
  "ReadAttrTestControl Custom",  \
  "TestSendFailCntControl Custom",  \
...
#define GENERATED_COMMANDS { \
    ...
    { 0xFC03, 0x00, COMMAND_MASK_OUTGOING_CLIENT | COMMAND_MASK_MANUFACTURER_SPECIFIC }, /* sengled_Test / Sengled_test */ \
  }
