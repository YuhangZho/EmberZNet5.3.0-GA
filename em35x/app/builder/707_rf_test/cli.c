...
static void sengledTESTControlCommand(void) {
  zclSimpleClientCommand( ZCL_SENGLED_TEST_CLUSTER_ID,
                          ZCL_SENGLED_TEST_COMMAND_ID);
}
...
PGM_P sengledTESTControlCommandArguments[] = {
  "sengled_cmd",
  "sengled_data",
  NULL
};

EmberCommandEntry sengledTESTCommands[] = {
  emberCommandEntryActionWithDetails("Control", sengledTESTControlCommand, "uv", "Command description for sengled_test", sengledTESTControlCommandArguments),
  emberCommandEntryTerminator()
};

EmberCommandEntry emberCommandTableSengledCommands[] = {
  emberCommandEntrySubMenu("TEST", sengledTESTCommands, ""),
  emberCommandEntryTerminator()
};
...
EmberCommandEntry emberCommandTable[] = {
  ...
  emberCommandEntrySubMenu("sengled", emberCommandTableSengledCommands, ""),
