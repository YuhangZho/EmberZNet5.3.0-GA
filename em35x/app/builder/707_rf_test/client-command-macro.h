...
/** @name sengled control Commands */
// @{
/** @} END sengled control Commands */


/** @name Mobile Scense Commands */
// @{
/** @brief Command description for MobileControl
 *
 * Cluster: Mobile Scense, This cluster provides SengLed Mobile Scense.
 * Command: MobileControl
 * @param controlType int16u
 * @param controlData int16u
 * @param transitionTime int16u
 */
#define emberAfFillCommandSengledMobileScenseClusterMobileControl(controlType, \
                                                                  controlData, \
                                                                  transitionTime) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_SENGLED_MOBILE_SCENSE_CLUSTER_ID, \
                                                0x1160, \
...
/** @} END Mobile Scense Commands */


/** @name sengled_Test Commands */
// @{
/** @brief Command description for sengled_test
 *
 * Cluster: sengled_Test, This cluster provides SengLed RGB test
 * Command: Sengled_test
 * @param sengled_cmd int8u
 * @param sengled_data int16u
 */
#define emberAfFillCommandSengledTestClusterSengled_test(sengled_cmd, \
                                                         sengled_data) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_SENGLED_TEST_CLUSTER_ID, \
                                                0x1160, \
