...
/** @addtogroup sengled_test Cluster Commands: sengled_Test
 * @ingroup cli
 * This group describes the CLI commands for the sengled_Test cluster. Listed
...
/** @brief <b>sengled TEST Control [sengled_cmd:1] [sengled_data:2] </b>
 *   - <i>Command description for sengled_test</i>
 *     - sengled_cmd - INT8U
 *     - sengled_data - INT16U
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_SENGLED__TEST_CONTROL
