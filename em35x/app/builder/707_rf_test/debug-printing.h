...
// Printing macros for cluster: sengled_Test
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_SENGLED_TEST_CLUSTER)
#define emberAfSengledTestClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_SENGLED_TEST_CLUSTER, __VA_ARGS__)
#define emberAfSengledTestClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_SENGLED_TEST_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfSengledTestClusterFlush()
#define emberAfSengledTestClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_SENGLED_TEST_CLUSTER) ) { x; }
#define emberAfSengledTestClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_SENGLED_TEST_CLUSTER, (buffer), (len), (withSpace))
#define emberAfSengledTestClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_SENGLED_TEST_CLUSTER, (buffer))
#else
#define emberAfSengledTestClusterPrint(...)
#define emberAfSengledTestClusterPrintln(...)
#define emberAfSengledTestClusterFlush()
#define emberAfSengledTestClusterDebugExec(x)
#define emberAfSengledTestClusterPrintBuffer(buffer, len, withSpace)
#define emberAfSengledTestClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_SENGLED_TEST_CLUSTER)
