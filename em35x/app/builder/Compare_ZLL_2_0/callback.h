...
/** @name RGB Test Cluster Callbacks */
// @{

/** @brief RGB Test Cluster Client Attribute Changed
 *
 * Client Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute that changed  Ver.: always
 */
void emberAfSengledRgbTestClusterClientAttributeChangedCallback(int8u endpoint,
                                                                EmberAfAttributeId attributeId);
/** @brief RGB Test Cluster Client Default Response
 *
 * This function is called when the client receives the default response from
 * the server.
 *
 ...
 * @param status Status in default response  Ver.: always
 */
void emberAfSengledRgbTestClusterClientDefaultResponseCallback(int8u endpoint,
                                                               int8u commandId,
                                                               EmberAfStatus status);
/** @brief RGB Test Cluster Client Init
 *
 * Client Init
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 */
void emberAfSengledRgbTestClusterClientInitCallback(int8u endpoint);
/** @brief RGB Test Cluster Client Manufacturer Specific Attribute Changed
 *
 * Client Manufacturer Specific Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * Ver.: always
 */
void emberAfSengledRgbTestClusterClientManufacturerSpecificAttributeChangedCallback(int8u endpoint,
                                                                                    EmberAfAttributeId attributeId,
                                                                                    int16u manufacturerCode);
/** @brief RGB Test Cluster Client Message Sent
 *
 * Client Message Sent
 *
 * @param type The type of message sent  Ver.: always
 ...
 * @param status The status of the sent message  Ver.: always
 */
void emberAfSengledRgbTestClusterClientMessageSentCallback(EmberOutgoingMessageType type,
                                                           int16u indexOrDestination,
                                                           EmberApsFrame *apsFrame,
                                                           int16u msgLen,
                                                           int8u *message,
                                                           EmberStatus status);
/** @brief RGB Test Cluster Client Pre Attribute Changed
 *
 * Client Pre Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * @param value Attribute value  Ver.: always
 */
EmberAfStatus emberAfSengledRgbTestClusterClientPreAttributeChangedCallback(int8u endpoint,
                                                                            EmberAfAttributeId attributeId,
                                                                            EmberAfAttributeType attributeType,
                                                                            int8u size,
                                                                            int8u *value);
/** @brief RGB Test Cluster Client Tick
 *
 * Client Tick
 *
 * @param endpoint Endpoint that is being served  Ver.: always
 */
void emberAfSengledRgbTestClusterClientTickCallback(int8u endpoint);
/** @brief RGB Test Cluster R G B_ P W M Control
 *
 * 
 *
 * @param RGB   Ver.: always
 * @param PWMData   Ver.: always
 */
boolean emberAfSengledRgbTestClusterRGB_PWMControlCallback(int8u RGB,
                                                           int8u PWMData);
/** @brief RGB Test Cluster Server Attribute Changed
 *
 * Server Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute that changed  Ver.: always
 */
void emberAfSengledRgbTestClusterServerAttributeChangedCallback(int8u endpoint,
                                                                EmberAfAttributeId attributeId);
/** @brief RGB Test Cluster Server Default Response
 *
 * This function is called when the server receives the default response from
 * the client.
 *
 ...
 * @param status Status in default response  Ver.: always
 */
void emberAfSengledRgbTestClusterServerDefaultResponseCallback(int8u endpoint,
                                                               int8u commandId,
                                                               EmberAfStatus status);
/** @brief RGB Test Cluster Server Init
 *
 * Server Init
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 */
void emberAfSengledRgbTestClusterServerInitCallback(int8u endpoint);
/** @brief RGB Test Cluster Server Manufacturer Specific Attribute Changed
 *
 * Server Manufacturer Specific Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * Ver.: always
 */
void emberAfSengledRgbTestClusterServerManufacturerSpecificAttributeChangedCallback(int8u endpoint,
                                                                                    EmberAfAttributeId attributeId,
                                                                                    int16u manufacturerCode);
/** @brief RGB Test Cluster Server Message Sent
 *
 * Server Message Sent
 *
 * @param type The type of message sent  Ver.: always
 ...
 * @param status The status of the sent message  Ver.: always
 */
void emberAfSengledRgbTestClusterServerMessageSentCallback(EmberOutgoingMessageType type,
                                                           int16u indexOrDestination,
                                                           EmberApsFrame *apsFrame,
                                                           int16u msgLen,
                                                           int8u *message,
                                                           EmberStatus status);
/** @brief RGB Test Cluster Server Pre Attribute Changed
 *
 * Server Pre Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * @param value Attribute value  Ver.: always
 */
EmberAfStatus emberAfSengledRgbTestClusterServerPreAttributeChangedCallback(int8u endpoint,
                                                                            EmberAfAttributeId attributeId,
                                                                            EmberAfAttributeType attributeType,
                                                                            int8u size,
                                                                            int8u *value);
/** @brief RGB Test Cluster Server Tick
 *
 * Server Tick
 *
 * @param endpoint Endpoint that is being served  Ver.: always
 */
void emberAfSengledRgbTestClusterServerTickCallback(int8u endpoint);

/** @} END RGB Test Cluster Callbacks */
