...
EmberCommandEntry zclSmCommands[] = {
  emberCommandEntryActionWithDetails("dm", zclSmDmCommand, "", "Command description for RemoveMirror", NULL),
  emberCommandEntryActionWithDetails("rm", zclSmRmCommand, "", "Command description for RequestMirror", NULL),
  emberCommandEntryTerminator()
};
...
PGM_P pluginSimpleMeteringServerAdjustCommandArguments[] = {
  "The endpoint of the test meter.",
  NULL
};

PGM_P pluginSimpleMeteringServerElectricCommandArguments[] = {
  "The endpoint of the test meter",
  NULL
};

PGM_P pluginSimpleMeteringServerGasCommandArguments[] = {
  "The endpoint of the test meter",
  NULL
};

PGM_P pluginSimpleMeteringServerOffCommandArguments[] = {
  "The endpoint of the test meter",
  NULL
};

PGM_P pluginSimpleMeteringServerProfilesCommandArguments[] = {
  "The profile to set",
  NULL
};

PGM_P pluginSimpleMeteringServerRateCommandArguments[] = {
  "The rate at which the test meter generates test data",
  NULL
};

PGM_P pluginSimpleMeteringServerRndErrorCommandArguments[] = {
  "The chance of an error occurring in 255",
  NULL
};

PGM_P pluginSimpleMeteringServerSetErrorCommandArguments[] = {
  "The chance of an error occurring in 255",
  "The endpoint affected",
  NULL
};

PGM_P pluginSimpleMeteringServerVarianceCommandArguments[] = {
  "rate",
  NULL
};
