...
EmberCommandEntry zllCommissioningScanCommands[] = {
...
PGM_P pluginZllCommissioningChannelCommandArguments[] = {
  "The channel to be used.",
  NULL
};

PGM_P pluginZllCommissioningEndpointsCommandArguments[] = {
...
PGM_P pluginZllCommissioningFormCommandArguments[] = {
...
PGM_P pluginZllCommissioningGroupsCommandArguments[] = {
  "The network address of the device to which the request will be sent.",
  "The source endpoint from which the request will be sent.",
  "The destination endpoint to which the request will be sent.",
...
PGM_P pluginZllCommissioningIdentifyCommandArguments[] = {
  "The duration (in tenths of a second) of identify mode or 0xFFFF to ind ...",
  NULL
};

PGM_P pluginZllCommissioningInfoCommandArguments[] = {
  "The network address of the device to which the request will be sent.",
  "The source endpoint from which the request will be sent.",
  "The destination endpoint to which the request will be sent.",
  NULL
...
PGM_P pluginZllCommissioningMaskCommandArguments[] = {
  "The index of the channel mask to be used.",
  NULL
};

EmberCommandEntry pluginZllCommissioningCommands[] = {
  ...
  emberCommandEntrySubMenu("scan", zllCommissioningScanCommands, ""),
...
EmberCommandEntry emberCommandTablePluginCommands[] = {
  ...
  emberCommandEntrySubMenu("zll-commissioning", pluginZllCommissioningCommands, ""),
  emberCommandEntryTerminator()
};
