...
/** @addtogroup rgb-calibration Cluster Commands: rgb calibration
 * @ingroup cli
 * This group describes the CLI commands for the rgb calibration cluster. Listed
 * below is a description of the cluster:<br><br><i> This cluster provides rgb
 * calibration</i>
 * 
 * @{
 */

/** @} */ // end group rgb-calibration
...
/** @brief <b>zcl colorcontrol movetohue [hue:1] [direction:1] [transitionTime:2] </b>
...
/** @brief <b>zcl colorcontrol movehue [moveMode:1] [rate:1] </b>
...
/** @brief <b>zcl colorcontrol stephue [stepMode:1] [stepSize:1] [transitionTime:1] </b>
...
/** @brief <b>zcl colorcontrol movetosat [saturation:1] [transitionTime:2] </b>
...
/** @brief <b>zcl colorcontrol movesat [moveMode:1] [rate:1] </b>
...
/** @brief <b>zcl colorcontrol stepsat [stepMode:1] [stepSize:1] [transitionTime:1] </b>
...
/** @brief <b>zcl colorcontrol movetohueandsat [hue:1] [saturation:1] [transitionTime:2] </b>
...
/** @brief <b>zcl colorcontrol movetocolor [colorX:2] [colorY:2] [transitionTime:2] </b>
...
/** @brief <b>zcl colorcontrol movecolor [rateX:2] [rateY:2] </b>
 *   - <i>Moves the color.</i>
 *     - rateX - INT16S
 *     - rateY - INT16S
 */
...
/** @brief <b>zcl colorcontrol stepcolor [stepX:2] [stepY:2] [transitionTime:2] </b>
...
/** @brief <b>zcl colorcontrol movetocolortemp [colorTemperature:2] [transitionTime:2] </b>
...
/** @brief <b>zcl colorcontrol emovetohue [enhancedHue:2] [direction:1] [transitionTime:2] </b>
...
/** @brief <b>zcl colorcontrol emovehue [moveMode:1] [rate:2] </b>
...
/** @brief <b>zcl colorcontrol estephue [stepMode:1] [stepSize:2] [transitionTime:2] </b>
...
/** @brief <b>zcl colorcontrol emovetohueandsat [enhancedHue:2] [saturation:1] [transitionTime:2] </b>
...
/** @brief <b>zcl colorcontrol loop [updateFlags:1] [action:1] [direction:1] [time:2] [startHue:2] </b>
...
/** @brief <b>zcl colorcontrol stopmovestep </b>
 *   - <i>Command description for StopMoveStep</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_COLOR_CONTROL_STOPMOVESTEP

/** @brief <b>zcl colorcontrol movecolortemp [moveMode:1] [rate:2] [colorTemperatureMinimum:2] [colorTemperatureMaximum:2] </b>
...
/** @brief <b>zcl colorcontrol stepcolortemp [stepMode:1] [stepSize:2] [transitionTime:2] [colorTemperatureMinimum:2] [colorTemperatureMaximum:2] </b>
...
/** @brief <b>zcl sm rm </b>
 *   - <i>Command description for RequestMirror</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_SIMPLE_METERING_RM

/** @brief <b>zcl sm dm </b>
 *   - <i>Command description for RemoveMirror</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_SIMPLE_METERING_DM

/** @brief <b>zcl sm gp [intervalChannel:1] [endTime:4] [numberOfPeriods:1] </b>
 *   - <i>Command description for GetProfile</i>
 ...
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_SIMPLE_METERING_GP

/** @brief <b>zcl sm fp [fastPollUpdatePeriod:1] [duration:1] </b>
 *   - <i>Command to request fast poll mode.</i>
 *     - fastPollUpdatePeriod - INT8U
 *     - duration - INT8U
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_SIMPLE_METERING_FP
...
/** @brief <b>rgb calibration [cali_cmd:1] [cali_data:4] </b>
 *   - <i>Command description for sengled_test</i>
 *     - cali_cmd - INT8U
 *     - cali_data - INT32U
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_RGB_CALIBRATION_CALIBRATION
