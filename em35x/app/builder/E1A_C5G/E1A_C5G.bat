...
echo " "
@echo on
cmd /c ""%PROJECT_DIR%\..\..\..\tool\image-builder\image-builder-windows.exe" --create %TARGET_BPATH%.ota  --version 3 --manuf-id 0x1160 --image-type 4 --tag-id 0x0000 --tag-file %TARGET_BPATH%.ebl --string "EBL E1A_C5G" > %TARGET_BPATH%-image-builder-output.txt"
@echo off
