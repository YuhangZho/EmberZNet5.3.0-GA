...
#endif
#if defined(ZCL_USING_SENGLED_TEST_CLUSTER_SERVER) || defined(ZCL_USING_SENGLED_TEST_CLUSTER_CLIENT)
  #define __PRINTCLUSTER_SENGLED_TEST_CLUSTER {ZCL_SENGLED_TEST_CLUSTER_ID, "sengled_Test" },
#else
  #define __PRINTCLUSTER_SENGLED_TEST_CLUSTER
#endif
#define CLUSTER_IDS_TO_NAMES \
  ...
  __PRINTCLUSTER_SENGLED_TEST_CLUSTER \
