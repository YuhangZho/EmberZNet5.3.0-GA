...
/** @name sengled control Cluster Callbacks */
// @{

/** @brief sengled control Cluster Client Attribute Changed
 *
 * Client Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute that changed  Ver.: always
 */
void emberAfSengledControlClusterClientAttributeChangedCallback(int8u endpoint,
                                                                EmberAfAttributeId attributeId);
/** @brief sengled control Cluster Client Default Response
 *
 * This function is called when the client receives the default response from
 * the server.
 *
 ...
 * @param status Status in default response  Ver.: always
 */
void emberAfSengledControlClusterClientDefaultResponseCallback(int8u endpoint,
                                                               int8u commandId,
                                                               EmberAfStatus status);
/** @brief sengled control Cluster Client Init
 *
 * Client Init
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 */
void emberAfSengledControlClusterClientInitCallback(int8u endpoint);
/** @brief sengled control Cluster Client Manufacturer Specific Attribute Changed
 *
 * Client Manufacturer Specific Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * Ver.: always
 */
void emberAfSengledControlClusterClientManufacturerSpecificAttributeChangedCallback(int8u endpoint,
                                                                                    EmberAfAttributeId attributeId,
                                                                                    int16u manufacturerCode);
/** @brief sengled control Cluster Client Message Sent
 *
 * Client Message Sent
 *
 * @param type The type of message sent  Ver.: always
 ...
 * @param status The status of the sent message  Ver.: always
 */
void emberAfSengledControlClusterClientMessageSentCallback(EmberOutgoingMessageType type,
                                                           int16u indexOrDestination,
                                                           EmberApsFrame *apsFrame,
                                                           int16u msgLen,
                                                           int8u *message,
                                                           EmberStatus status);
/** @brief sengled control Cluster Client Pre Attribute Changed
 *
 * Client Pre Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * @param value Attribute value  Ver.: always
 */
EmberAfStatus emberAfSengledControlClusterClientPreAttributeChangedCallback(int8u endpoint,
                                                                            EmberAfAttributeId attributeId,
                                                                            EmberAfAttributeType attributeType,
                                                                            int8u size,
                                                                            int8u *value);
/** @brief sengled control Cluster Client Tick
 *
 * Client Tick
 *
 * @param endpoint Endpoint that is being served  Ver.: always
 */
void emberAfSengledControlClusterClientTickCallback(int8u endpoint);
/** @brief sengled control Cluster Server Attribute Changed
 *
 * Server Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute that changed  Ver.: always
 */
void emberAfSengledControlClusterServerAttributeChangedCallback(int8u endpoint,
                                                                EmberAfAttributeId attributeId);
/** @brief sengled control Cluster Server Default Response
 *
 * This function is called when the server receives the default response from
 * the client.
 *
 ...
 * @param status Status in default response  Ver.: always
 */
void emberAfSengledControlClusterServerDefaultResponseCallback(int8u endpoint,
                                                               int8u commandId,
                                                               EmberAfStatus status);
/** @brief sengled control Cluster Server Init
 *
 * Server Init
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 */
void emberAfSengledControlClusterServerInitCallback(int8u endpoint);
/** @brief sengled control Cluster Server Manufacturer Specific Attribute Changed
 *
 * Server Manufacturer Specific Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * Ver.: always
 */
void emberAfSengledControlClusterServerManufacturerSpecificAttributeChangedCallback(int8u endpoint,
                                                                                    EmberAfAttributeId attributeId,
                                                                                    int16u manufacturerCode);
/** @brief sengled control Cluster Server Message Sent
 *
 * Server Message Sent
 *
 * @param type The type of message sent  Ver.: always
 ...
 * @param status The status of the sent message  Ver.: always
 */
void emberAfSengledControlClusterServerMessageSentCallback(EmberOutgoingMessageType type,
                                                           int16u indexOrDestination,
                                                           EmberApsFrame *apsFrame,
                                                           int16u msgLen,
                                                           int8u *message,
                                                           EmberStatus status);
/** @brief sengled control Cluster Server Pre Attribute Changed
 *
 * Server Pre Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * @param value Attribute value  Ver.: always
 */
EmberAfStatus emberAfSengledControlClusterServerPreAttributeChangedCallback(int8u endpoint,
                                                                            EmberAfAttributeId attributeId,
                                                                            EmberAfAttributeType attributeType,
                                                                            int8u size,
                                                                            int8u *value);
/** @brief sengled control Cluster Server Tick
 *
 * Server Tick
 *
 * @param endpoint Endpoint that is being served  Ver.: always
 */
void emberAfSengledControlClusterServerTickCallback(int8u endpoint);

/** @} END sengled control Cluster Callbacks */

/** @name Mobile Scense Cluster Callbacks */
// @{

/** @brief Mobile Scense Cluster Client Attribute Changed
 *
 * Client Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute that changed  Ver.: always
 */
void emberAfSengledMobileScenseClusterClientAttributeChangedCallback(int8u endpoint,
                                                                     EmberAfAttributeId attributeId);
/** @brief Mobile Scense Cluster Client Default Response
 *
 * This function is called when the client receives the default response from
 * the server.
 *
 ...
 * @param status Status in default response  Ver.: always
 */
void emberAfSengledMobileScenseClusterClientDefaultResponseCallback(int8u endpoint,
                                                                    int8u commandId,
                                                                    EmberAfStatus status);
/** @brief Mobile Scense Cluster Client Init
 *
 * Client Init
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 */
void emberAfSengledMobileScenseClusterClientInitCallback(int8u endpoint);
/** @brief Mobile Scense Cluster Client Manufacturer Specific Attribute Changed
 *
 * Client Manufacturer Specific Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * Ver.: always
 */
void emberAfSengledMobileScenseClusterClientManufacturerSpecificAttributeChangedCallback(int8u endpoint,
                                                                                         EmberAfAttributeId attributeId,
                                                                                         int16u manufacturerCode);
/** @brief Mobile Scense Cluster Client Message Sent
 *
 * Client Message Sent
 *
 * @param type The type of message sent  Ver.: always
 ...
 * @param status The status of the sent message  Ver.: always
 */
void emberAfSengledMobileScenseClusterClientMessageSentCallback(EmberOutgoingMessageType type,
                                                                int16u indexOrDestination,
                                                                EmberApsFrame *apsFrame,
                                                                int16u msgLen,
                                                                int8u *message,
                                                                EmberStatus status);
/** @brief Mobile Scense Cluster Client Pre Attribute Changed
 *
 * Client Pre Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * @param value Attribute value  Ver.: always
 */
EmberAfStatus emberAfSengledMobileScenseClusterClientPreAttributeChangedCallback(int8u endpoint,
                                                                                 EmberAfAttributeId attributeId,
                                                                                 EmberAfAttributeType attributeType,
                                                                                 int8u size,
                                                                                 int8u *value);
/** @brief Mobile Scense Cluster Client Tick
 *
 * Client Tick
 *
 * @param endpoint Endpoint that is being served  Ver.: always
 */
void emberAfSengledMobileScenseClusterClientTickCallback(int8u endpoint);
...
boolean emberAfSengledMobileScenseClusterMobileControlCallback(int16u controlType,
                                                               int16u controlData,
                                                               int16u transitionTime);
/** @brief Mobile Scense Cluster Server Attribute Changed
 *
 * Server Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute that changed  Ver.: always
 */
void emberAfSengledMobileScenseClusterServerAttributeChangedCallback(int8u endpoint,
                                                                     EmberAfAttributeId attributeId);
/** @brief Mobile Scense Cluster Server Default Response
 *
 * This function is called when the server receives the default response from
 * the client.
 *
 ...
 * @param status Status in default response  Ver.: always
 */
void emberAfSengledMobileScenseClusterServerDefaultResponseCallback(int8u endpoint,
                                                                    int8u commandId,
                                                                    EmberAfStatus status);
/** @brief Mobile Scense Cluster Server Init
 *
 * Server Init
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 */
void emberAfSengledMobileScenseClusterServerInitCallback(int8u endpoint);
/** @brief Mobile Scense Cluster Server Manufacturer Specific Attribute Changed
 *
 * Server Manufacturer Specific Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * Ver.: always
 */
void emberAfSengledMobileScenseClusterServerManufacturerSpecificAttributeChangedCallback(int8u endpoint,
                                                                                         EmberAfAttributeId attributeId,
                                                                                         int16u manufacturerCode);
/** @brief Mobile Scense Cluster Server Message Sent
 *
 * Server Message Sent
 *
 * @param type The type of message sent  Ver.: always
 ...
 * @param status The status of the sent message  Ver.: always
 */
void emberAfSengledMobileScenseClusterServerMessageSentCallback(EmberOutgoingMessageType type,
                                                                int16u indexOrDestination,
                                                                EmberApsFrame *apsFrame,
                                                                int16u msgLen,
                                                                int8u *message,
                                                                EmberStatus status);
/** @brief Mobile Scense Cluster Server Pre Attribute Changed
 *
 * Server Pre Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * @param value Attribute value  Ver.: always
 */
EmberAfStatus emberAfSengledMobileScenseClusterServerPreAttributeChangedCallback(int8u endpoint,
                                                                                 EmberAfAttributeId attributeId,
                                                                                 EmberAfAttributeType attributeType,
                                                                                 int8u size,
                                                                                 int8u *value);
/** @brief Mobile Scense Cluster Server Tick
 *
 * Server Tick
 *
 * @param endpoint Endpoint that is being served  Ver.: always
 */
void emberAfSengledMobileScenseClusterServerTickCallback(int8u endpoint);

/** @} END Mobile Scense Cluster Callbacks */

/** @name sengled_Test Cluster Callbacks */
// @{

/** @brief sengled_Test Cluster Client Attribute Changed
 *
 * Client Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute that changed  Ver.: always
 */
void emberAfSengledTestClusterClientAttributeChangedCallback(int8u endpoint,
                                                             EmberAfAttributeId attributeId);
/** @brief sengled_Test Cluster Client Default Response
 *
 * This function is called when the client receives the default response from
 * the server.
 *
 ...
 * @param status Status in default response  Ver.: always
 */
void emberAfSengledTestClusterClientDefaultResponseCallback(int8u endpoint,
                                                            int8u commandId,
                                                            EmberAfStatus status);
/** @brief sengled_Test Cluster Client Init
 *
 * Client Init
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 */
void emberAfSengledTestClusterClientInitCallback(int8u endpoint);
/** @brief sengled_Test Cluster Client Manufacturer Specific Attribute Changed
 *
 * Client Manufacturer Specific Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * Ver.: always
 */
void emberAfSengledTestClusterClientManufacturerSpecificAttributeChangedCallback(int8u endpoint,
                                                                                 EmberAfAttributeId attributeId,
                                                                                 int16u manufacturerCode);
/** @brief sengled_Test Cluster Client Message Sent
 *
 * Client Message Sent
 *
 * @param type The type of message sent  Ver.: always
 ...
 * @param status The status of the sent message  Ver.: always
 */
void emberAfSengledTestClusterClientMessageSentCallback(EmberOutgoingMessageType type,
                                                        int16u indexOrDestination,
                                                        EmberApsFrame *apsFrame,
                                                        int16u msgLen,
                                                        int8u *message,
                                                        EmberStatus status);
/** @brief sengled_Test Cluster Client Pre Attribute Changed
 *
 * Client Pre Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * @param value Attribute value  Ver.: always
 */
EmberAfStatus emberAfSengledTestClusterClientPreAttributeChangedCallback(int8u endpoint,
                                                                         EmberAfAttributeId attributeId,
                                                                         EmberAfAttributeType attributeType,
                                                                         int8u size,
                                                                         int8u *value);
/** @brief sengled_Test Cluster Client Tick
 *
 * Client Tick
 *
 * @param endpoint Endpoint that is being served  Ver.: always
 */
void emberAfSengledTestClusterClientTickCallback(int8u endpoint);
/** @brief sengled_Test Cluster Sengled_test
 *
 * 
 *
 * @param sengled_cmd   Ver.: always
 * @param sengled_data   Ver.: always
 */
boolean emberAfSengledTestClusterSengled_testCallback(int8u sengled_cmd,
                                                      int16u sengled_data);
/** @brief sengled_Test Cluster Server Attribute Changed
 *
 * Server Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute that changed  Ver.: always
 */
void emberAfSengledTestClusterServerAttributeChangedCallback(int8u endpoint,
                                                             EmberAfAttributeId attributeId);
/** @brief sengled_Test Cluster Server Default Response
 *
 * This function is called when the server receives the default response from
 * the client.
 *
 ...
 * @param status Status in default response  Ver.: always
 */
void emberAfSengledTestClusterServerDefaultResponseCallback(int8u endpoint,
                                                            int8u commandId,
                                                            EmberAfStatus status);
/** @brief sengled_Test Cluster Server Init
 *
 * Server Init
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 */
void emberAfSengledTestClusterServerInitCallback(int8u endpoint);
/** @brief sengled_Test Cluster Server Manufacturer Specific Attribute Changed
 *
 * Server Manufacturer Specific Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * Ver.: always
 */
void emberAfSengledTestClusterServerManufacturerSpecificAttributeChangedCallback(int8u endpoint,
                                                                                 EmberAfAttributeId attributeId,
                                                                                 int16u manufacturerCode);
/** @brief sengled_Test Cluster Server Message Sent
 *
 * Server Message Sent
 *
 * @param type The type of message sent  Ver.: always
 ...
 * @param status The status of the sent message  Ver.: always
 */
void emberAfSengledTestClusterServerMessageSentCallback(EmberOutgoingMessageType type,
                                                        int16u indexOrDestination,
                                                        EmberApsFrame *apsFrame,
                                                        int16u msgLen,
                                                        int8u *message,
                                                        EmberStatus status);
/** @brief sengled_Test Cluster Server Pre Attribute Changed
 *
 * Server Pre Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * @param value Attribute value  Ver.: always
 */
EmberAfStatus emberAfSengledTestClusterServerPreAttributeChangedCallback(int8u endpoint,
                                                                         EmberAfAttributeId attributeId,
                                                                         EmberAfAttributeType attributeType,
                                                                         int8u size,
                                                                         int8u *value);
/** @brief sengled_Test Cluster Server Tick
 *
 * Server Tick
 *
 * @param endpoint Endpoint that is being served  Ver.: always
 */
void emberAfSengledTestClusterServerTickCallback(int8u endpoint);

/** @} END sengled_Test Cluster Callbacks */
...
/** @name Interpan Plugin Plugin Callbacks */
// @{
...
/** @} END Interpan Plugin Plugin Callbacks */
 ...
 * @param deviceInformationRecordList The list of sub-device information records
 * for the target.  Ver.: always
 */
 ...
 *
 * This function is called by the ZLL Commissioning plugin to obtain information
 * about the group identifiers in use by a specific endpoint on the device.  The
 * application should populate the record with information about the group
 * identifier and return TRUE.  If no information is available for the given
 * endpoint and index, the application should return FALSE.
 *
 ...
 *
 * This function is called by the ZLL Commissioning plugin to obtain information
 * about the remote endpoints controlled by a specific endpoint on the local
 * device.  The application should populate the record with information about
 * the remote endpoint and return TRUE.  If no information is available for the
