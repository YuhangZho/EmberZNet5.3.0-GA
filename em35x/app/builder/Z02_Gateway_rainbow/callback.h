...
/** @name par38 control Cluster Callbacks */
// @{

/** @brief par38 control Cluster Client Attribute Changed
 *
 * Client Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute that changed  Ver.: always
 */
void emberAfPar38ControlClusterClientAttributeChangedCallback(int8u endpoint,
                                                              EmberAfAttributeId attributeId);
/** @brief par38 control Cluster Client Default Response
 *
 * This function is called when the client receives the default response from
 * the server.
 *
 ...
 * @param status Status in default response  Ver.: always
 */
void emberAfPar38ControlClusterClientDefaultResponseCallback(int8u endpoint,
                                                             int8u commandId,
                                                             EmberAfStatus status);
/** @brief par38 control Cluster Client Init
 *
 * Client Init
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 */
void emberAfPar38ControlClusterClientInitCallback(int8u endpoint);
/** @brief par38 control Cluster Client Manufacturer Specific Attribute Changed
 *
 * Client Manufacturer Specific Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * Ver.: always
 */
void emberAfPar38ControlClusterClientManufacturerSpecificAttributeChangedCallback(int8u endpoint,
                                                                                  EmberAfAttributeId attributeId,
                                                                                  int16u manufacturerCode);
/** @brief par38 control Cluster Client Message Sent
 *
 * Client Message Sent
 *
 * @param type The type of message sent  Ver.: always
 ...
 * @param status The status of the sent message  Ver.: always
 */
void emberAfPar38ControlClusterClientMessageSentCallback(EmberOutgoingMessageType type,
                                                         int16u indexOrDestination,
                                                         EmberApsFrame *apsFrame,
                                                         int16u msgLen,
                                                         int8u *message,
                                                         EmberStatus status);
/** @brief par38 control Cluster Client Pre Attribute Changed
 *
 * Client Pre Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * @param value Attribute value  Ver.: always
 */
EmberAfStatus emberAfPar38ControlClusterClientPreAttributeChangedCallback(int8u endpoint,
                                                                          EmberAfAttributeId attributeId,
                                                                          EmberAfAttributeType attributeType,
                                                                          int8u size,
                                                                          int8u *value);
/** @brief par38 control Cluster Client Tick
 *
 * Client Tick
 *
 * @param endpoint Endpoint that is being served  Ver.: always
 */
void emberAfPar38ControlClusterClientTickCallback(int8u endpoint);
/** @brief par38 control Cluster Server Attribute Changed
 *
 * Server Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute that changed  Ver.: always
 */
void emberAfPar38ControlClusterServerAttributeChangedCallback(int8u endpoint,
                                                              EmberAfAttributeId attributeId);
/** @brief par38 control Cluster Server Default Response
 *
 * This function is called when the server receives the default response from
 * the client.
 *
 ...
 * @param status Status in default response  Ver.: always
 */
void emberAfPar38ControlClusterServerDefaultResponseCallback(int8u endpoint,
                                                             int8u commandId,
                                                             EmberAfStatus status);
/** @brief par38 control Cluster Server Init
 *
 * Server Init
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 */
void emberAfPar38ControlClusterServerInitCallback(int8u endpoint);
/** @brief par38 control Cluster Server Manufacturer Specific Attribute Changed
 *
 * Server Manufacturer Specific Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * Ver.: always
 */
void emberAfPar38ControlClusterServerManufacturerSpecificAttributeChangedCallback(int8u endpoint,
                                                                                  EmberAfAttributeId attributeId,
                                                                                  int16u manufacturerCode);
/** @brief par38 control Cluster Server Message Sent
 *
 * Server Message Sent
 *
 * @param type The type of message sent  Ver.: always
 ...
 * @param status The status of the sent message  Ver.: always
 */
void emberAfPar38ControlClusterServerMessageSentCallback(EmberOutgoingMessageType type,
                                                         int16u indexOrDestination,
                                                         EmberApsFrame *apsFrame,
                                                         int16u msgLen,
                                                         int8u *message,
                                                         EmberStatus status);
/** @brief par38 control Cluster Server Pre Attribute Changed
 *
 * Server Pre Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * @param value Attribute value  Ver.: always
 */
EmberAfStatus emberAfPar38ControlClusterServerPreAttributeChangedCallback(int8u endpoint,
                                                                          EmberAfAttributeId attributeId,
                                                                          EmberAfAttributeType attributeType,
                                                                          int8u size,
                                                                          int8u *value);
/** @brief par38 control Cluster Server Tick
 *
 * Server Tick
 *
 * @param endpoint Endpoint that is being served  Ver.: always
 */
void emberAfPar38ControlClusterServerTickCallback(int8u endpoint);

/** @} END par38 control Cluster Callbacks */

/** @name mobile control Cluster Callbacks */
// @{

/** @brief mobile control Cluster Client Attribute Changed
 *
 * Client Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute that changed  Ver.: always
 */
void emberAfMobileControlClusterClientAttributeChangedCallback(int8u endpoint,
                                                               EmberAfAttributeId attributeId);
/** @brief mobile control Cluster Client Default Response
 *
 * This function is called when the client receives the default response from
 * the server.
 *
 ...
 * @param status Status in default response  Ver.: always
 */
void emberAfMobileControlClusterClientDefaultResponseCallback(int8u endpoint,
                                                              int8u commandId,
                                                              EmberAfStatus status);
/** @brief mobile control Cluster Client Init
 *
 * Client Init
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 */
void emberAfMobileControlClusterClientInitCallback(int8u endpoint);
/** @brief mobile control Cluster Client Manufacturer Specific Attribute Changed
 *
 * Client Manufacturer Specific Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * Ver.: always
 */
void emberAfMobileControlClusterClientManufacturerSpecificAttributeChangedCallback(int8u endpoint,
                                                                                   EmberAfAttributeId attributeId,
                                                                                   int16u manufacturerCode);
/** @brief mobile control Cluster Client Message Sent
 *
 * Client Message Sent
 *
 * @param type The type of message sent  Ver.: always
 ...
 * @param status The status of the sent message  Ver.: always
 */
void emberAfMobileControlClusterClientMessageSentCallback(EmberOutgoingMessageType type,
                                                          int16u indexOrDestination,
                                                          EmberApsFrame *apsFrame,
                                                          int16u msgLen,
                                                          int8u *message,
                                                          EmberStatus status);
/** @brief mobile control Cluster Client Pre Attribute Changed
 *
 * Client Pre Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * @param value Attribute value  Ver.: always
 */
EmberAfStatus emberAfMobileControlClusterClientPreAttributeChangedCallback(int8u endpoint,
                                                                           EmberAfAttributeId attributeId,
                                                                           EmberAfAttributeType attributeType,
                                                                           int8u size,
                                                                           int8u *value);
/** @brief mobile control Cluster Client Tick
 *
 * Client Tick
 *
 * @param endpoint Endpoint that is being served  Ver.: always
 */
void emberAfMobileControlClusterClientTickCallback(int8u endpoint);
/** @brief mobile control Cluster Mobile control
 *
 * 
 *
 * @param control_type   Ver.: always
 * @param control_data   Ver.: always
 * @param transition_time   Ver.: always
 */
boolean emberAfMobileControlClusterMobilecontrolCallback(int16u control_type,
                                                         int16u control_data,
                                                         int16u transition_time);
/** @brief mobile control Cluster Server Attribute Changed
 *
 * Server Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute that changed  Ver.: always
 */
void emberAfMobileControlClusterServerAttributeChangedCallback(int8u endpoint,
                                                               EmberAfAttributeId attributeId);
/** @brief mobile control Cluster Server Default Response
 *
 * This function is called when the server receives the default response from
 * the client.
 *
 ...
 * @param status Status in default response  Ver.: always
 */
void emberAfMobileControlClusterServerDefaultResponseCallback(int8u endpoint,
                                                              int8u commandId,
                                                              EmberAfStatus status);
/** @brief mobile control Cluster Server Init
 *
 * Server Init
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 */
void emberAfMobileControlClusterServerInitCallback(int8u endpoint);
/** @brief mobile control Cluster Server Manufacturer Specific Attribute Changed
 *
 * Server Manufacturer Specific Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * Ver.: always
 */
void emberAfMobileControlClusterServerManufacturerSpecificAttributeChangedCallback(int8u endpoint,
                                                                                   EmberAfAttributeId attributeId,
                                                                                   int16u manufacturerCode);
/** @brief mobile control Cluster Server Message Sent
 *
 * Server Message Sent
 *
 * @param type The type of message sent  Ver.: always
 ...
 * @param status The status of the sent message  Ver.: always
 */
void emberAfMobileControlClusterServerMessageSentCallback(EmberOutgoingMessageType type,
                                                          int16u indexOrDestination,
                                                          EmberApsFrame *apsFrame,
                                                          int16u msgLen,
                                                          int8u *message,
                                                          EmberStatus status);
/** @brief mobile control Cluster Server Pre Attribute Changed
 *
 * Server Pre Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * @param value Attribute value  Ver.: always
 */
EmberAfStatus emberAfMobileControlClusterServerPreAttributeChangedCallback(int8u endpoint,
                                                                           EmberAfAttributeId attributeId,
                                                                           EmberAfAttributeType attributeType,
                                                                           int8u size,
                                                                           int8u *value);
/** @brief mobile control Cluster Server Tick
 *
 * Server Tick
 *
 * @param endpoint Endpoint that is being served  Ver.: always
 */
void emberAfMobileControlClusterServerTickCallback(int8u endpoint);

/** @} END mobile control Cluster Callbacks */

/** @name rgb calibration Cluster Callbacks */
// @{

/** @brief rgb calibration Cluster Client Attribute Changed
 *
 * Client Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute that changed  Ver.: always
 */
void emberAfRgbCalirationClusterClientAttributeChangedCallback(int8u endpoint,
                                                               EmberAfAttributeId attributeId);
/** @brief rgb calibration Cluster Client Default Response
 *
 * This function is called when the client receives the default response from
 * the server.
 *
 ...
 * @param status Status in default response  Ver.: always
 */
void emberAfRgbCalirationClusterClientDefaultResponseCallback(int8u endpoint,
                                                              int8u commandId,
                                                              EmberAfStatus status);
/** @brief rgb calibration Cluster Client Init
 *
 * Client Init
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 */
void emberAfRgbCalirationClusterClientInitCallback(int8u endpoint);
/** @brief rgb calibration Cluster Client Manufacturer Specific Attribute Changed
 *
 * Client Manufacturer Specific Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * Ver.: always
 */
void emberAfRgbCalirationClusterClientManufacturerSpecificAttributeChangedCallback(int8u endpoint,
                                                                                   EmberAfAttributeId attributeId,
                                                                                   int16u manufacturerCode);
/** @brief rgb calibration Cluster Client Message Sent
 *
 * Client Message Sent
 *
 * @param type The type of message sent  Ver.: always
 ...
 * @param status The status of the sent message  Ver.: always
 */
void emberAfRgbCalirationClusterClientMessageSentCallback(EmberOutgoingMessageType type,
                                                          int16u indexOrDestination,
                                                          EmberApsFrame *apsFrame,
                                                          int16u msgLen,
                                                          int8u *message,
                                                          EmberStatus status);
/** @brief rgb calibration Cluster Client Pre Attribute Changed
 *
 * Client Pre Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * @param value Attribute value  Ver.: always
 */
EmberAfStatus emberAfRgbCalirationClusterClientPreAttributeChangedCallback(int8u endpoint,
                                                                           EmberAfAttributeId attributeId,
                                                                           EmberAfAttributeType attributeType,
                                                                           int8u size,
                                                                           int8u *value);
/** @brief rgb calibration Cluster Client Tick
 *
 * Client Tick
 *
 * @param endpoint Endpoint that is being served  Ver.: always
 */
void emberAfRgbCalirationClusterClientTickCallback(int8u endpoint);
/** @brief rgb calibration Cluster Rgb_calibration
 *
 * 
 *
 * @param cali_cmd   Ver.: always
 * @param cali_data   Ver.: always
 */
boolean emberAfRgbCalirationClusterRgb_calibrationCallback(int8u cali_cmd,
                                                           int32u cali_data);
/** @brief rgb calibration Cluster Server Attribute Changed
 *
 * Server Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute that changed  Ver.: always
 */
void emberAfRgbCalirationClusterServerAttributeChangedCallback(int8u endpoint,
                                                               EmberAfAttributeId attributeId);
/** @brief rgb calibration Cluster Server Default Response
 *
 * This function is called when the server receives the default response from
 * the client.
 *
 ...
 * @param status Status in default response  Ver.: always
 */
void emberAfRgbCalirationClusterServerDefaultResponseCallback(int8u endpoint,
                                                              int8u commandId,
                                                              EmberAfStatus status);
/** @brief rgb calibration Cluster Server Init
 *
 * Server Init
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 */
void emberAfRgbCalirationClusterServerInitCallback(int8u endpoint);
/** @brief rgb calibration Cluster Server Manufacturer Specific Attribute Changed
 *
 * Server Manufacturer Specific Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * Ver.: always
 */
void emberAfRgbCalirationClusterServerManufacturerSpecificAttributeChangedCallback(int8u endpoint,
                                                                                   EmberAfAttributeId attributeId,
                                                                                   int16u manufacturerCode);
/** @brief rgb calibration Cluster Server Message Sent
 *
 * Server Message Sent
 *
 * @param type The type of message sent  Ver.: always
 ...
 * @param status The status of the sent message  Ver.: always
 */
void emberAfRgbCalirationClusterServerMessageSentCallback(EmberOutgoingMessageType type,
                                                          int16u indexOrDestination,
                                                          EmberApsFrame *apsFrame,
                                                          int16u msgLen,
                                                          int8u *message,
                                                          EmberStatus status);
/** @brief rgb calibration Cluster Server Pre Attribute Changed
 *
 * Server Pre Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * @param value Attribute value  Ver.: always
 */
EmberAfStatus emberAfRgbCalirationClusterServerPreAttributeChangedCallback(int8u endpoint,
                                                                           EmberAfAttributeId attributeId,
                                                                           EmberAfAttributeType attributeType,
                                                                           int8u size,
                                                                           int8u *value);
/** @brief rgb calibration Cluster Server Tick
 *
 * Server Tick
 *
 * @param endpoint Endpoint that is being served  Ver.: always
 */
void emberAfRgbCalirationClusterServerTickCallback(int8u endpoint);

/** @} END rgb calibration Cluster Callbacks */

/** @name light auto reset mark Cluster Callbacks */
// @{

/** @brief light auto reset mark Cluster Client Attribute Changed
 *
 * Client Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute that changed  Ver.: always
 */
void emberAfAutoResetClusterClientAttributeChangedCallback(int8u endpoint,
                                                           EmberAfAttributeId attributeId);
/** @brief light auto reset mark Cluster Client Default Response
 *
 * This function is called when the client receives the default response from
 * the server.
 *
 ...
 * @param status Status in default response  Ver.: always
 */
void emberAfAutoResetClusterClientDefaultResponseCallback(int8u endpoint,
                                                          int8u commandId,
                                                          EmberAfStatus status);
/** @brief light auto reset mark Cluster Client Init
 *
 * Client Init
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 */
void emberAfAutoResetClusterClientInitCallback(int8u endpoint);
/** @brief light auto reset mark Cluster Client Manufacturer Specific Attribute Changed
 *
 * Client Manufacturer Specific Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * Ver.: always
 */
void emberAfAutoResetClusterClientManufacturerSpecificAttributeChangedCallback(int8u endpoint,
                                                                               EmberAfAttributeId attributeId,
                                                                               int16u manufacturerCode);
/** @brief light auto reset mark Cluster Client Message Sent
 *
 * Client Message Sent
 *
 * @param type The type of message sent  Ver.: always
 ...
 * @param status The status of the sent message  Ver.: always
 */
void emberAfAutoResetClusterClientMessageSentCallback(EmberOutgoingMessageType type,
                                                      int16u indexOrDestination,
                                                      EmberApsFrame *apsFrame,
                                                      int16u msgLen,
                                                      int8u *message,
                                                      EmberStatus status);
/** @brief light auto reset mark Cluster Client Pre Attribute Changed
 *
 * Client Pre Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * @param value Attribute value  Ver.: always
 */
EmberAfStatus emberAfAutoResetClusterClientPreAttributeChangedCallback(int8u endpoint,
                                                                       EmberAfAttributeId attributeId,
                                                                       EmberAfAttributeType attributeType,
                                                                       int8u size,
                                                                       int8u *value);
/** @brief light auto reset mark Cluster Client Tick
 *
 * Client Tick
 *
 * @param endpoint Endpoint that is being served  Ver.: always
 */
void emberAfAutoResetClusterClientTickCallback(int8u endpoint);
/** @brief light auto reset mark Cluster Server Attribute Changed
 *
 * Server Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute that changed  Ver.: always
 */
void emberAfAutoResetClusterServerAttributeChangedCallback(int8u endpoint,
                                                           EmberAfAttributeId attributeId);
/** @brief light auto reset mark Cluster Server Default Response
 *
 * This function is called when the server receives the default response from
 * the client.
 *
 ...
 * @param status Status in default response  Ver.: always
 */
void emberAfAutoResetClusterServerDefaultResponseCallback(int8u endpoint,
                                                          int8u commandId,
                                                          EmberAfStatus status);
/** @brief light auto reset mark Cluster Server Init
 *
 * Server Init
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 */
void emberAfAutoResetClusterServerInitCallback(int8u endpoint);
/** @brief light auto reset mark Cluster Server Manufacturer Specific Attribute Changed
 *
 * Server Manufacturer Specific Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
...
void emberAfAutoResetClusterServerManufacturerSpecificAttributeChangedCallback(int8u endpoint,
                                                                               EmberAfAttributeId attributeId,
                                                                               int16u manufacturerCode);
/** @brief light auto reset mark Cluster Server Message Sent
 *
 * Server Message Sent
 *
 * @param type The type of message sent  Ver.: always
 ...
 * @param status The status of the sent message  Ver.: always
 */
void emberAfAutoResetClusterServerMessageSentCallback(EmberOutgoingMessageType type,
                                                      int16u indexOrDestination,
                                                      EmberApsFrame *apsFrame,
                                                      int16u msgLen,
                                                      int8u *message,
                                                      EmberStatus status);
/** @brief light auto reset mark Cluster Server Pre Attribute Changed
 *
 * Server Pre Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * @param value Attribute value  Ver.: always
 */
EmberAfStatus emberAfAutoResetClusterServerPreAttributeChangedCallback(int8u endpoint,
                                                                       EmberAfAttributeId attributeId,
                                                                       EmberAfAttributeType attributeType,
                                                                       int8u size,
                                                                       int8u *value);
/** @brief light auto reset mark Cluster Server Tick
 *
 * Server Tick
 *
 * @param endpoint Endpoint that is being served  Ver.: always
 */
void emberAfAutoResetClusterServerTickCallback(int8u endpoint);

/** @} END light auto reset mark Cluster Callbacks */

/** @name diagnose code itself Cluster Callbacks */
// @{

/** @brief diagnose code itself Cluster Client Attribute Changed
 *
 * Client Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute that changed  Ver.: always
 */
void emberAfDiagCodeClusterClientAttributeChangedCallback(int8u endpoint,
                                                          EmberAfAttributeId attributeId);
/** @brief diagnose code itself Cluster Client Default Response
 *
 * This function is called when the client receives the default response from
 * the server.
 *
 ...
 * @param status Status in default response  Ver.: always
 */
void emberAfDiagCodeClusterClientDefaultResponseCallback(int8u endpoint,
                                                         int8u commandId,
                                                         EmberAfStatus status);
/** @brief diagnose code itself Cluster Client Init
 *
 * Client Init
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 */
void emberAfDiagCodeClusterClientInitCallback(int8u endpoint);
/** @brief diagnose code itself Cluster Client Manufacturer Specific Attribute Changed
 *
 * Client Manufacturer Specific Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * Ver.: always
 */
void emberAfDiagCodeClusterClientManufacturerSpecificAttributeChangedCallback(int8u endpoint,
                                                                              EmberAfAttributeId attributeId,
                                                                              int16u manufacturerCode);
/** @brief diagnose code itself Cluster Client Message Sent
 *
 * Client Message Sent
 *
 * @param type The type of message sent  Ver.: always
 ...
 * @param status The status of the sent message  Ver.: always
 */
void emberAfDiagCodeClusterClientMessageSentCallback(EmberOutgoingMessageType type,
                                                     int16u indexOrDestination,
                                                     EmberApsFrame *apsFrame,
                                                     int16u msgLen,
                                                     int8u *message,
                                                     EmberStatus status);
/** @brief diagnose code itself Cluster Client Pre Attribute Changed
 *
 * Client Pre Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * @param value Attribute value  Ver.: always
 */
EmberAfStatus emberAfDiagCodeClusterClientPreAttributeChangedCallback(int8u endpoint,
                                                                      EmberAfAttributeId attributeId,
                                                                      EmberAfAttributeType attributeType,
                                                                      int8u size,
                                                                      int8u *value);
/** @brief diagnose code itself Cluster Client Tick
 *
 * Client Tick
 *
 * @param endpoint Endpoint that is being served  Ver.: always
 */
void emberAfDiagCodeClusterClientTickCallback(int8u endpoint);
/** @brief diagnose code itself Cluster Diag code broadcast
 *
 * 
 *
 * @param context   Ver.: always
 */
boolean emberAfDiagCodeClusterDiagcodebroadcastCallback(int8u* context);
/** @brief diagnose code itself Cluster Server Attribute Changed
 *
 * Server Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute that changed  Ver.: always
 */
void emberAfDiagCodeClusterServerAttributeChangedCallback(int8u endpoint,
                                                          EmberAfAttributeId attributeId);
/** @brief diagnose code itself Cluster Server Default Response
 *
 * This function is called when the server receives the default response from
 * the client.
 *
 ...
 * @param status Status in default response  Ver.: always
 */
void emberAfDiagCodeClusterServerDefaultResponseCallback(int8u endpoint,
                                                         int8u commandId,
                                                         EmberAfStatus status);
/** @brief diagnose code itself Cluster Server Init
 *
 * Server Init
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 */
void emberAfDiagCodeClusterServerInitCallback(int8u endpoint);
/** @brief diagnose code itself Cluster Server Manufacturer Specific Attribute Changed
 *
 * Server Manufacturer Specific Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * Ver.: always
 */
void emberAfDiagCodeClusterServerManufacturerSpecificAttributeChangedCallback(int8u endpoint,
                                                                              EmberAfAttributeId attributeId,
                                                                              int16u manufacturerCode);
/** @brief diagnose code itself Cluster Server Message Sent
 *
 * Server Message Sent
 *
 * @param type The type of message sent  Ver.: always
 ...
 * @param status The status of the sent message  Ver.: always
 */
void emberAfDiagCodeClusterServerMessageSentCallback(EmberOutgoingMessageType type,
                                                     int16u indexOrDestination,
                                                     EmberApsFrame *apsFrame,
                                                     int16u msgLen,
                                                     int8u *message,
                                                     EmberStatus status);
/** @brief diagnose code itself Cluster Server Pre Attribute Changed
 *
 * Server Pre Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * @param value Attribute value  Ver.: always
 */
EmberAfStatus emberAfDiagCodeClusterServerPreAttributeChangedCallback(int8u endpoint,
                                                                      EmberAfAttributeId attributeId,
                                                                      EmberAfAttributeType attributeType,
                                                                      int8u size,
                                                                      int8u *value);
/** @brief diagnose code itself Cluster Server Tick
 *
 * Server Tick
 *
 * @param endpoint Endpoint that is being served  Ver.: always
 */
void emberAfDiagCodeClusterServerTickCallback(int8u endpoint);

/** @} END diagnose code itself Cluster Callbacks */
...
/** @name Z02 Gateway App Plugin Callbacks */
// @{

/** @brief Make Join Decision
 *
 * This callback is fired when a device attempts to join the network, and asks
 * if you would like to allow it to join or not. Return TRUE to allow node to
 * join the network.
 *
 * @param nodeId   Ver.: always
 * @param nodeEUI64   Ver.: always
 */
boolean emberAfPluginZ02GatewayAppMakeJoinDecisionCallback(EmberNodeId nodeId,
                                                           EmberEUI64 nodeEUI64);

/** @} END Z02 Gateway App Plugin Callbacks */
