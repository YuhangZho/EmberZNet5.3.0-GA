...
#endif
#if defined(ZCL_USING_SENGLED_CLUSTER_SERVER) || defined(ZCL_USING_SENGLED_CLUSTER_CLIENT)
  #define __PRINTCLUSTER_SENGLED_CLUSTER {ZCL_SENGLED_CLUSTER_ID, "Sengled" },
#else
  #define __PRINTCLUSTER_SENGLED_CLUSTER
#endif
...
#define CLUSTER_IDS_TO_NAMES \
  ...
  __PRINTCLUSTER_SENGLED_CLUSTER \
