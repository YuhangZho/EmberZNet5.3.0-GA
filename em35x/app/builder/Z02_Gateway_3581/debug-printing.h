...
// Printing macros for cluster: Sengled
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_SENGLED_CLUSTER)
#define emberAfSengledClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_SENGLED_CLUSTER, __VA_ARGS__)
#define emberAfSengledClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_SENGLED_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfSengledClusterFlush()
#define emberAfSengledClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_SENGLED_CLUSTER) ) { x; }
#define emberAfSengledClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_SENGLED_CLUSTER, (buffer), (len), (withSpace))
#define emberAfSengledClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_SENGLED_CLUSTER, (buffer))
#else
#define emberAfSengledClusterPrint(...)
#define emberAfSengledClusterPrintln(...)
#define emberAfSengledClusterFlush()
#define emberAfSengledClusterDebugExec(x)
#define emberAfSengledClusterPrintBuffer(buffer, len, withSpace)
#define emberAfSengledClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_SENGLED_CLUSTER)
