...
echo " "
@echo on
cmd /c "%PROJECT_DIR%\..\..\..\tool\image-builder\image-builder-windows.exe --create %TARGET_BPATH%.ota  --version 0x0000000c --manuf-id 0x1160 --image-type 0x0002 --tag-id 0x0000 --tag-file %TARGET_BPATH%.ebl --string "EBL Z01_A19EUE27" > %TARGET_BPATH%-image-builder-output.txt"
@echo off
