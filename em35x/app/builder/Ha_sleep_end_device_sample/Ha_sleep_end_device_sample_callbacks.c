...
{
#ifdef ROBIN_DEBUG
//  emberAfGuaranteedPrintln("IdleSleepOkToSleepCallback:tuneDone:%x",tuneDone); // Robin add for debug
#endif
...
{
#ifdef ROBIN_DEBUG
	emberAfGuaranteedPrintln("Force Short Poll"); // Robin add for debug
#endif
