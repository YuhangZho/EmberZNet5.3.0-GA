...
#endif
#if defined(ZCL_USING_TOU_CALENDAR_CLUSTER_SERVER) || defined(ZCL_USING_TOU_CALENDAR_CLUSTER_CLIENT)
  #define __PRINTCLUSTER_TOU_CALENDAR_CLUSTER {ZCL_TOU_CALENDAR_CLUSTER_ID, "TOU Calendar" },
#else
  #define __PRINTCLUSTER_TOU_CALENDAR_CLUSTER
#endif
...
#endif
#if defined(ZCL_USING_PAR38_CONTROL_CLUSTER_SERVER) || defined(ZCL_USING_PAR38_CONTROL_CLUSTER_CLIENT)
  #define __PRINTCLUSTER_PAR38_CONTROL_CLUSTER {ZCL_PAR38_CONTROL_CLUSTER_ID, "par38 control" },
#else
  #define __PRINTCLUSTER_PAR38_CONTROL_CLUSTER
#endif
#if defined(ZCL_USING_MOBILE_CONTROL_CLUSTER_SERVER) || defined(ZCL_USING_MOBILE_CONTROL_CLUSTER_CLIENT)
  #define __PRINTCLUSTER_MOBILE_CONTROL_CLUSTER {ZCL_MOBILE_CONTROL_CLUSTER_ID, "mobile control" },
#else
  #define __PRINTCLUSTER_MOBILE_CONTROL_CLUSTER
#endif
#if defined(ZCL_USING_RGB_CALIRATION_CLUSTER_SERVER) || defined(ZCL_USING_RGB_CALIRATION_CLUSTER_CLIENT)
  #define __PRINTCLUSTER_RGB_CALIRATION_CLUSTER {ZCL_RGB_CALIRATION_CLUSTER_ID, "rgb calibration" },
#else
  #define __PRINTCLUSTER_RGB_CALIRATION_CLUSTER
#endif
#if defined(ZCL_USING_AUTO_RESET_CLUSTER_SERVER) || defined(ZCL_USING_AUTO_RESET_CLUSTER_CLIENT)
  #define __PRINTCLUSTER_AUTO_RESET_CLUSTER {ZCL_AUTO_RESET_CLUSTER_ID, "light auto reset mark" },
#else
  #define __PRINTCLUSTER_AUTO_RESET_CLUSTER
#endif
#if defined(ZCL_USING_DIAG_CODE_CLUSTER_SERVER) || defined(ZCL_USING_DIAG_CODE_CLUSTER_CLIENT)
  #define __PRINTCLUSTER_DIAG_CODE_CLUSTER {ZCL_DIAG_CODE_CLUSTER_ID, "diagnose code itself" },
#else
  #define __PRINTCLUSTER_DIAG_CODE_CLUSTER
#endif
#define CLUSTER_IDS_TO_NAMES \
  ...
  __PRINTCLUSTER_TOU_CALENDAR_CLUSTER \
  ...
  __PRINTCLUSTER_PAR38_CONTROL_CLUSTER \
  __PRINTCLUSTER_MOBILE_CONTROL_CLUSTER \
  __PRINTCLUSTER_RGB_CALIRATION_CLUSTER \
  __PRINTCLUSTER_AUTO_RESET_CLUSTER \
  __PRINTCLUSTER_DIAG_CODE_CLUSTER \
