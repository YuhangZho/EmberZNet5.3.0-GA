...
#define GENERATED_CLUSTERS { \
    ...
    { 0xFC01, (EmberAfAttributeMetadata*)&(generatedAttributes[3]), 0, 0, (CLUSTER_MASK_CLIENT), NULL,  },    \
  }
...
#define EMBER_AF_GENERATED_PLUGIN_COMMAND_DECLARATIONS \
  extern EmberCommandEntry emberAfPluginAddressTableCommands[]; \
  extern EmberCommandEntry emberAfPluginConcentratorCommands[]; \
  extern EmberCommandEntry emberAfPluginCountersCommands[]; \
  extern EmberCommandEntry emberAfPluginEepromCommands[]; \
  extern EmberCommandEntry emberAfPluginIdentifyCommands[]; \
  extern EmberCommandEntry emberAfPluginOtaServerCommands[]; \
  extern EmberCommandEntry emberAfPluginOtaStorageCommonCommands[]; \
  extern EmberCommandEntry emberAfPluginOtaStorageSimpleEepromCommands[]; \


#define EMBER_AF_GENERATED_PLUGIN_COMMAND_ENTRIES \
  {"address-table", NULL, (PGM_P)emberAfPluginAddressTableCommands}, \
  {"concentrator", NULL, (PGM_P)emberAfPluginConcentratorCommands}, \
  {"counters", NULL, (PGM_P)emberAfPluginCountersCommands}, \
  {"eeprom", NULL, (PGM_P)emberAfPluginEepromCommands}, \
  {"identify", NULL, (PGM_P)emberAfPluginIdentifyCommands}, \
  {"ota-server", NULL, (PGM_P)emberAfPluginOtaServerCommands}, \
  {"ota-storage-common", NULL, (PGM_P)emberAfPluginOtaStorageCommonCommands}, \
  {"ota-storage-simple-eeprom", NULL, (PGM_P)emberAfPluginOtaStorageSimpleEepromCommands}, \
...
#define GENERATED_COMMANDS { \
    ...
    { 0x0702, 0x00, COMMAND_MASK_OUTGOING_CLIENT }, /* Simple Metering / GetProfile */ \
    { 0x0702, 0x01, COMMAND_MASK_OUTGOING_CLIENT }, /* Simple Metering / RequestMirrorResponse */ \
    { 0x0702, 0x02, COMMAND_MASK_OUTGOING_CLIENT }, /* Simple Metering / MirrorRemoved */ \
    { 0x0702, 0x03, COMMAND_MASK_OUTGOING_CLIENT }, /* Simple Metering / RequestFastPollMode */ \
    { 0x0702, 0x04, COMMAND_MASK_OUTGOING_CLIENT }, /* Simple Metering / ScheduleSnapshot */ \
    { 0x0702, 0x05, COMMAND_MASK_OUTGOING_CLIENT }, /* Simple Metering / TakeSnapshot */ \
    { 0x0702, 0x06, COMMAND_MASK_OUTGOING_CLIENT }, /* Simple Metering / GetSnapshot */ \
    { 0x0702, 0x07, COMMAND_MASK_OUTGOING_CLIENT }, /* Simple Metering / StartSampling */ \
    { 0x0702, 0x08, COMMAND_MASK_OUTGOING_CLIENT }, /* Simple Metering / GetSampledData */ \
    { 0x0702, 0x09, COMMAND_MASK_OUTGOING_CLIENT }, /* Simple Metering / MirrorReportAttributeResponse */ \
    { 0x0702, 0x0A, COMMAND_MASK_OUTGOING_CLIENT }, /* Simple Metering / ResetLoadLimitCounter */ \
  }
