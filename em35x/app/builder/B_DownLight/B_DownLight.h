...
#ifndef __APP_B_DOWNLIGHT_H__
#define __APP_B_DOWNLIGHT_H__


/**** Included Header Section ****/
#define ROBIN_DEBUG
/**** ZCL Section ****/
#define ZA_PROMPT "B_DownLight"
...
#define EMBER_AF_PRINT_ON_OFF_CLUSTER 0x0002
#define EMBER_AF_PRINT_LEVEL_CONTROL_CLUSTER 0x0004
#define EMBER_AF_PRINT_COLOR_CONTROL_CLUSTER 0x0008
...
// Use this macro to check if Sengled HA Common DownLight plugin is included
#define EMBER_AF_PLUGIN_SENGLED_HA_COMMON_DOWNLIGHT

// Use this macro to check if Sengled Hardware Ezmode plugin is included
#define EMBER_AF_PLUGIN_SENGLED_HA_EZMODE

// Use this macro to check if Sengled HA Network DownLight plugin is included
#define EMBER_AF_PLUGIN_SENGLED_HA_NETWORK_DOWNLIGHT

// Use this macro to check if Sengled Hardware DownLight plugin is included
#define EMBER_AF_PLUGIN_SENGLED_HARDWARE_DOWNLIGHT
