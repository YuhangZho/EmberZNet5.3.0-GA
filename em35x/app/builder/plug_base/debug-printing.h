...
// Printing macros for cluster: sengled control
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_SENGLED_CONTROL_CLUSTER)
#define emberAfSengledControlClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_SENGLED_CONTROL_CLUSTER, __VA_ARGS__)
#define emberAfSengledControlClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_SENGLED_CONTROL_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfSengledControlClusterFlush()
#define emberAfSengledControlClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_SENGLED_CONTROL_CLUSTER) ) { x; }
#define emberAfSengledControlClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_SENGLED_CONTROL_CLUSTER, (buffer), (len), (withSpace))
#define emberAfSengledControlClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_SENGLED_CONTROL_CLUSTER, (buffer))
#else
#define emberAfSengledControlClusterPrint(...)
#define emberAfSengledControlClusterPrintln(...)
#define emberAfSengledControlClusterFlush()
#define emberAfSengledControlClusterDebugExec(x)
#define emberAfSengledControlClusterPrintBuffer(buffer, len, withSpace)
#define emberAfSengledControlClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_SENGLED_CONTROL_CLUSTER)


// Printing macros for cluster: Mobile Scense
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_SENGLED_MOBILE_SCENSE_CLUSTER)
#define emberAfSengledMobileScenseClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_SENGLED_MOBILE_SCENSE_CLUSTER, __VA_ARGS__)
#define emberAfSengledMobileScenseClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_SENGLED_MOBILE_SCENSE_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfSengledMobileScenseClusterFlush()
#define emberAfSengledMobileScenseClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_SENGLED_MOBILE_SCENSE_CLUSTER) ) { x; }
#define emberAfSengledMobileScenseClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_SENGLED_MOBILE_SCENSE_CLUSTER, (buffer), (len), (withSpace))
#define emberAfSengledMobileScenseClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_SENGLED_MOBILE_SCENSE_CLUSTER, (buffer))
#else
#define emberAfSengledMobileScenseClusterPrint(...)
#define emberAfSengledMobileScenseClusterPrintln(...)
#define emberAfSengledMobileScenseClusterFlush()
#define emberAfSengledMobileScenseClusterDebugExec(x)
#define emberAfSengledMobileScenseClusterPrintBuffer(buffer, len, withSpace)
#define emberAfSengledMobileScenseClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_SENGLED_MOBILE_SCENSE_CLUSTER)


// Printing macros for cluster: RGB Test
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_SENGLED_RGB_TEST_CLUSTER)
#define emberAfSengledRgbTestClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_SENGLED_RGB_TEST_CLUSTER, __VA_ARGS__)
#define emberAfSengledRgbTestClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_SENGLED_RGB_TEST_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfSengledRgbTestClusterFlush()
#define emberAfSengledRgbTestClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_SENGLED_RGB_TEST_CLUSTER) ) { x; }
#define emberAfSengledRgbTestClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_SENGLED_RGB_TEST_CLUSTER, (buffer), (len), (withSpace))
#define emberAfSengledRgbTestClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_SENGLED_RGB_TEST_CLUSTER, (buffer))
#else
#define emberAfSengledRgbTestClusterPrint(...)
#define emberAfSengledRgbTestClusterPrintln(...)
#define emberAfSengledRgbTestClusterFlush()
#define emberAfSengledRgbTestClusterDebugExec(x)
#define emberAfSengledRgbTestClusterPrintBuffer(buffer, len, withSpace)
#define emberAfSengledRgbTestClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_SENGLED_RGB_TEST_CLUSTER)
