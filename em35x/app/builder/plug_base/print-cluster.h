...
#endif
#if defined(ZCL_USING_SENGLED_CONTROL_CLUSTER_SERVER) || defined(ZCL_USING_SENGLED_CONTROL_CLUSTER_CLIENT)
  #define __PRINTCLUSTER_SENGLED_CONTROL_CLUSTER {ZCL_SENGLED_CONTROL_CLUSTER_ID, "sengled control" },
#else
  #define __PRINTCLUSTER_SENGLED_CONTROL_CLUSTER
#endif
#if defined(ZCL_USING_SENGLED_MOBILE_SCENSE_CLUSTER_SERVER) || defined(ZCL_USING_SENGLED_MOBILE_SCENSE_CLUSTER_CLIENT)
  #define __PRINTCLUSTER_SENGLED_MOBILE_SCENSE_CLUSTER {ZCL_SENGLED_MOBILE_SCENSE_CLUSTER_ID, "Mobile Scense" },
#else
  #define __PRINTCLUSTER_SENGLED_MOBILE_SCENSE_CLUSTER
#endif
#if defined(ZCL_USING_SENGLED_RGB_TEST_CLUSTER_SERVER) || defined(ZCL_USING_SENGLED_RGB_TEST_CLUSTER_CLIENT)
  #define __PRINTCLUSTER_SENGLED_RGB_TEST_CLUSTER {ZCL_SENGLED_RGB_TEST_CLUSTER_ID, "RGB Test" },
#else
  #define __PRINTCLUSTER_SENGLED_RGB_TEST_CLUSTER
#endif
#define CLUSTER_IDS_TO_NAMES \
  ...
  __PRINTCLUSTER_SENGLED_CONTROL_CLUSTER \
  __PRINTCLUSTER_SENGLED_MOBILE_SCENSE_CLUSTER \
  __PRINTCLUSTER_SENGLED_RGB_TEST_CLUSTER \
